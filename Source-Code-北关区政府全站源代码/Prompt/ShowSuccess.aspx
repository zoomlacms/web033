<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Admin.Prompt.ShowSuccess, App_Web_thnd4tca" enableviewstatemac="false" validaterequest="false" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content runat="server" ContentPlaceHolderID="head">
    <style type="text/css">ul li{list-style-type:none;}.glyphicon{margin-right:3px;}</style> 
    <title>成功提示</title>
</asp:Content>
