<%@ page language="C#" autoeventwireup="true" inherits="Prompt_ShopCart_Passengers, App_Web_r4yvxr4c" masterpagefile="~/Cart/order.master" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
  ...
  <%--  <div><strong>保险数量:</strong><asp:TextBox runat="server" ID="Safenum_T" CssClass="form-control" /></div>--%>
    <div class="panel panel-primary">
        <div class="panel-heading"><span class="glyphicon glyphicon-user"></span><span class="margin_l5">旅客信息</span> <div class="pull-right"></div> <button type="button" class="btn btn-info" onclick="ShowSelCustomer()" style="color:#fff;"><span class="glyphicon glyphicon-plus"></span> 选择客户</button></div>
        <div class="panel-body">
            <ul id="user_ul">
        <li>
            <table class='table table-bordered'>
