<%@ page language="C#" autoeventwireup="true" inherits="try_ReBack, App_Web_wksq4ark" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content runat="server" ContentPlaceHolderID="head"><title>在线眼镜试戴</title></asp:Content>
            ...
            <div role="tabpanel" class="tab-pane active" id="main_tab">
                ...
                <div class="tab-content">
                            ...
                            <div class="row">
                                <div class="col-md-4 padding20 container_3d">
                                    <div class="imgmodel_div rote_left" data-target="upimg_div" onclick="SetPhoto(this);">
                                        <span class="glyphicon glyphicon-floppy-open img_icon"></span>
                                        <br />
                                        <span>本地上传</span>
                                    </div>
                                </div>
                                <div class="col-md-4 padding20">
                                    <div class="imgmodel_div center_div" onclick="location.href='/dai';" data-target="selimg_div">
                                        <span class="glyphicon glyphicon-picture img_icon"></span>
                                        <br />
                                        <span>在线选择</span>
                                    </div>
                                </div>
                                <div class="col-md-4 padding20 container_3d">
                                    <div class="imgmodel_div rote_right" data-target="cameraimg_div" onclick="SetPhoto(this)">
                                        <span class="glyphicon glyphicon-camera img_icon"></span>
                                        <br />
                                        <span>在线拍照</span>
                                    </div>
                                </div>
                    ...
                    <div role="tabpanel" class="tab-pane tab_div" id="setphone">
                        <div id="upimg_div" class="imgaction" style="display: none;">
                            <div class="row">
                        ...
                        <div id="cameraimg_div" class="imgaction">
                            <iframe id="camera_ifr" src="Camera.aspx" style="border: none; width: 100%; height: 500px;"></iframe>
                        </div>
                        <div class="text-center margin_t10">
                            <button type="button" class="btn btn-primary camera_btn" onclick="shoot(1)">拍摄正面</button>
                            <%-- <button type="button" class="btn btn-primary camera_btn" onclick="shoot(2)">拍摄侧面</button>--%>
                            <button type="button" class="btn btn-primary camera_btn" onclick="clearPhoto()">重置拍照</button>
                        ...
                        <div class="row" style="margin: 5px;">
                            <div class="col-lg-6 col-md-6 padding20 photoview">
                                <div class="nophoto_div" data-target="cameraimg_div" onclick="SetPhoto(this)">
                                    <span class="glyphicon glyphicon-picture nophoto_ico"></span>
                                    <br />
                                    您还没有照片,点此拍张照吧!
                                </div>
                                <div class="photo_bar">
...
<asp:Content runat="server" ContentPlaceHolderID="Script">
    ...
    <style>
        ...
        .testpro_div #main_tab {
            padding: 10px;
            border: 1px solid #ddd;
            border-top: none;
        }

        .testpro_div .form-control {
        ...
        .testpro_div .tab_div {
            ...
            .testpro_div .tab_div .tips {
                color: #d80909;
            }

        .testpro_div #tablist .active a {
            color: #d80909 !important;
        }

        .testpro_div #tablist li a {
            font-size: 12px;
        }

        .testpro_div .container_3d {
        ...
        /* -moz-transform:rotateY(100deg); -ms-transform:rotateY(100deg);-o-transform:rotateY(100deg);transform:rotateY(100deg);*/
        .testpro_div .rote_right {
            -webkit-transform: rotateY(-30deg);
            -moz-transform: rotateY(-30deg);
            -ms-transform: rotateY(-30deg);
            -o-transform: rotateY(-30deg);
        ...
        .testpro_div .center_div {
            -webkit-transform: scale(.92,.92);
            transform: scale(.92,.92);
        }

        .testpro_div .upimg_title {
            font-weight: 900;
        }

        .testpro_div .imgmodel_div {
            ...
            .testpro_div .imgmodel_div .img_icon {
                font-size: 80px;
            }

            .testpro_div .imgmodel_div:hover {
                border-color: #999;
            }

        .testpro_div .photo_div .photo_img_div {
            background-color: #eee;
            height: 400px;
            cursor: pointer;
        }

            .testpro_div .photo_div .photo_img_div img {
                width: 100%;
                height: 100%;
            }

        .testpro_div .photolist_div {
            height: 410px;
            border-top: none;
            padding: 10px;
            overflow: auto;
        ...
        .testpro_div .glasslist_div {
            height: 540px;
            overflow: auto;
        }

        .photoview .nophoto_div {
            position: absolute;
        ...
        .photo_bar .leftGrip:hover {
            background-color: #337ab7;
        }

        .photo_bar .toolbtn:hover {
            color: #337ab7;
        }
    ...
    <script>
        ...
        $().ready(function () {
            ...
            $('a[aria-controls="setphone"]').on('shown.bs.tab', function (e) {
                if ($("#cameraimg_div").is(":visible")) {
                    //启动子页面相机功能
