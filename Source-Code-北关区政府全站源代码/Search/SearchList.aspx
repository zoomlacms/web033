<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.SearchList, App_Web_q4wlg5w3" enableviewstate="false" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE HTML>
<html lang="zh-cn">
<head>
<meta charset="utf-8" />
...
<style>
    ...
    .searchfoot {position: fixed; bottom: 0px; width: 100%; height: 50px;}
</style>
</head>
<body>
    <div class="relative">
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="/User/Register.aspx" target="_blank"><i class="fa fa-plus-circle"></i>会员注册</a></li>
                        <li><a href="/User/" target="_blank"><i class="fa fa-user"></i>用户登录</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                <form runat="server" id="myform">
                    <div style="width: 500px;">
                            <asp:DropDownList ID="DDLNode" runat="server" CssClass="form-control pull-left text_md" onchange="UpdateNode();">
                            </asp:DropDownList>
