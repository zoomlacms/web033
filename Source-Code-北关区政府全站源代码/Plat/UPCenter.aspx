<%@ page language="C#" autoeventwireup="true" inherits="Plat_RegisterDetail, App_Web_4miqgixo" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<ul class="nav nav-tabs">
  ...
  <li><a href="/User/ChangPSW.aspx">修改密码</a></li>
</ul>
      ...
      <table class="table table-bordered table-hover table-striped">
        ...
        <tr>
          ...
          <td>
            ...
            <asp:Image runat="server" ID="pre_img" CssClass="img-circle" Style="width: 50px; height: 50px; margin-left: 30px;" />
            </span></td>
        </tr>
        <tr>
