<%@ page language="C#" autoeventwireup="true" inherits="Plat_Blog_PosSign, App_Web_55qshzck" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <div><i class="glyphicon glyphicon-map-marker"></i><span id="add_final_sp"></span></div>
          </div>
