<%@ page language="C#" autoeventwireup="true" inherits="test_test, App_Web_55qshzck" masterpagefile="~/Plat/Empty.master" enableviewstate="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="row">
  <div>
    ...
    <div id="img_div" style="text-align:center;max-width:960px;margin:auto;"> 
        <img id="img1" src="/Images/userface/noface.gif" data-id="1" class="img_pre col-lg-4 col-md-4 col-sm-4 col-xs-12" onclick="ShowFile(1)" /> 
        <img src="/Images/userface/noface.gif" data-id="2" class="img_pre col-lg-4 col-md-4 col-sm-4 col-xs-12" onclick="ShowFile(2)" />
        <img id="img3" src="/Images/userface/noface.gif" data-id="3" class="img_pre col-lg-4 col-md-4 col-sm-4 col-xs-12" onclick="ShowFile(3)" /> </div>
