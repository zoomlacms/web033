<%@ page language="C#" autoeventwireup="true" inherits="Plat_Admin_Default, App_Web_atks25ot" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="input-group nav_searchDiv margin_t5">
  ...
  <asp:LinkButton runat="server" CssClass="btn btn-default" OnClick="Search_Btn_Click" ID="Search_Btn"><span class="glyphicon glyphicon-search"></span></asp:LinkButton>
  </span> </div>
  ...
  <asp:TemplateField HeaderText="操作">
	<ItemTemplate> 
      <a href="/Plat/blog/?Uids=<%#Eval("UserID") %>" target="_blank" title="查看他的工作流"><span class="fa fa-eye"></span></a>
        <a href="/Plat/UPCenter.aspx?uid=<%#Eval("UserID") %>" title="修改" style="margin-left:5px;"><span class="glyphicon glyphicon-pencil"></span></a>
