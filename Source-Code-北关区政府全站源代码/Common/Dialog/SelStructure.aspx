<%@ page language="C#" autoeventwireup="true" inherits="Common_Dialog_SelStructure, App_Web_eor5fmlo" clientidmode="Static" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <ContentTemplate>
                    <div style="float: left; margin-left: 10px; width: 580px; top: 2px;">
                        <div style="margin-bottom: 5px;">
                            当前部门:<asp:Label runat="server" ID="curLabel" Style="color: green;">全部用户</asp:Label>
                        ...
                        <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" EnableTheming="False" CssClass="table table-bordered table-striped" EmptyDataText="没有用户"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="WorkNum" HeaderText="工号" SortExpression="WorkNum"></asp:BoundField>
