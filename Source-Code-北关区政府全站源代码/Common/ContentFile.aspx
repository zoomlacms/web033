<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Common.FileUpload, App_Web_qcoejleu" enableviewstatemac="false" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table style="height: 100%; border: 0; width: 100%">
        <tr class="tdbg">
            <td >
                <asp:FileUpload ID="FupFile" runat="server" Style="display: inline;width:50%;" />
                &nbsp;                           
