<%@ page language="C#" autoeventwireup="true" inherits="Common_SelFiles, App_Web_rjy0ij2p" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="container-fluid">
        ...
        <div class="form-group">
            ...
            <asp:FileUpload ID="FileUp_F" runat="server" style="display:none;" />
