<%@ page language="C#" autoeventwireup="true" inherits="MIS_ZLOA_Main, App_Web_rpzzopgu" masterpagefile="~/MIS/OA.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                            ...
                            <div class="inContent executive">
                                <table class="myTable threeTr">
                                    <tr class="hover_hander">
                                        <td><a href="javascript:;" onclick="ShowMain('#draftdoc_ul','/Mis/OA/Drafting.aspx')">
                                            <img src="Images/Main/official.gif" /><div>公文拟稿</div>
                                        </a></td>
                                        <td>
                                            <a href="javascript:;" onclick="ShowMain('#agencydoc_ul','/Mis/OA/AffairsList.aspx?view=1')">
                                                <img src="Images/Main/wait.gif" /><div>待办公文<span id="affairSpan" style="color: red;"></span></div>
                                            </a></td>
                                        <td><a href="javascript:;" onclick="ShowMain('#office_ul','/Mis/OA/AffairsList.aspx?view=2')">
                                            <img src="Images/Main/done.gif" /><div>已办事务</div>
                                        </a></td>
                                    </tr>
                                    <tr class="hover_hander">
                                        <td><a href="javascript:;" onclick="ShowMain('#senddoc_ul','/Mis/OA/Office/Default.aspx')">
                                            <img src="Images/Main/post.gif" /><div>发文管理</div>
                                        </a></td>
                                        <td><a href="javascript:;" onclick="ShowMain('#recdoc_ul','/Mis/OA/AffairsList.aspx?view=3')">
                                            <img src="Images/Main/Receipt.gif" /><div>收文管理</div>
                                        </a></td>
                                        <td><a href="javascript:;" onclick="ShowMain('#readdoc_ul','/Mis/OA/Office/DocManage.aspx')">
                    ...
                    <div class="OAborder">
                        ...
                        <div class="content templatelist">
                            <div class="inContent office">
                                <table class="myTable threeTr">
                                    <tr class="hover_hander">
                                        <td><a href="javascript:;" onclick="ShowMain('#newdoc_ul','/Mis/OA/Flow/FlowList.aspx')">
                                            <img src="Images/Main/draft.gif" /><div>新建发文</div>
                                        </a></td>
                                        <td><a href="/Mis/OA/Flow/ApplyList.aspx?view=3">
                                            <img src="Images/Main/ziyuan.gif" /><div>我的公文</div>
                                        </a></td>
                                        <td><a href="/Mis/OA/Flow/ApplyList.aspx?view=1">
                                            <img src="Images/Main/Awaiting.gif" /><div class="oa_item">待审公文
                                            <span class="item_count" runat="server" id="wait_sp">0</span></div>
                                        </a></td>
                                        <td><a href="/Mis/OA/Flow/ApplyList.aspx?view=2">
                                    ...
                                    <tr class="hover_hander"> 
                                        ...
                                        <td><a href="javascript:;" onclick="ShowMain('#newdoc_ul','/Mis/OA/Flow/ApplyList.aspx?view=4')">
                                            <img src="Images/Main/schedule.gif" /><div>我的借阅</div>
                                        </a></td>
                                        <td><a href="javascript:;" onclick="ShowMain('#doclist_ul','/Mis/OA/Doc/FiledList.aspx')">
                                            <img src="Images/Main/schedule.gif" /><div>档案管理</div>
                                        </a></td>
                                        <td><a href="javascript:;" onclick="ShowMain('#doclist_ul','/Mis/OA/Doc/BorrowList.aspx')">
                                ...
                                <table class="myTable threeTr">
                                    <tr class="hover_hander">
                                        <td><a href="Flow/FlowApply.aspx?ProID=1">
                                            <span class="glyphicon glyphicon-log-in prcess"></span><div>新建收文</div>
                                        </a></td>
                                        <td><a href="Flow/FlowApply.aspx?ProID=2">
                                            <span class="glyphicon glyphicon-log-out prcess"></span><div>新建发文</div>
                                        </a></td>
                    ...
                    <div class="OAborder">
                        ...
                        <div class="content templatelist">
                            <div class="inContent email">
                                <table class="myTable threeTr">
                                    <tr class="hover_hander">
                                        <td><a href="javascript:;" onclick="ShowMain('Mail/MailManage.aspx','/Mis/OA/Mail/MessageSend.aspx')">
                                            <img src="Images/Main/writemail.gif" /><div>写邮件</div>
                                        </a></td>
                                        <td><a href="javascript:;" onclick="ShowMain('Mail/MailManage.aspx','/Mis/OA/Mail/Message.aspx')">
                                            <img src="Images/Main/recivemail.gif" />
                                            <div class="oa_item">
                                                收邮件<span class="item_count" runat="server" id="Span2">0</span>
                                            </div>
                                        </a></td>
                                        <td><a href="javascript:;" onclick="ShowMain('Mail/MailManage.aspx','/Mis/OA/Mail/MessageOutbox.aspx')">
                                            <img src="Images/Main/sendmail.gif" /><div>发件箱</div>
                                        </a></td>
                                    </tr>
                                    <tr class="hover_hander">
                                        <td><a href="javascript:;" onclick="ShowMain('Mail/MailManage.aspx','/Mis/OA/Mail/MessageDraftbox.aspx')">
                                            <img src="Images/Main/draftmail.gif" /><div>草稿箱</div>
                                        </a></td>
                                        <td><a href="javascript:;" onclick="ShowMain('Mail/MailManage.aspx','/Mis/OA/Mail/MessageGarbagebox.aspx')">
                                            <img src="Images/Main/rubbishmali.gif" /><div>垃圾箱</div>
                                        </a></td>
                                        <td><a href="javascript:;" onclick="ShowMain('Mail/MailManage.aspx','/Mis/OA/Other/StructList.aspx')">
