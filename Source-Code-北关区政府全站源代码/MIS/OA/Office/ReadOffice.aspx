<%@ page language="C#" autoeventwireup="true" inherits="MIS_ZLOA_Office_ReadOffice, App_Web_3ewvw2au" clientidmode="Static" validaterequest="false" masterpagefile="~/User/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div id="main" style="margin:5px 0 0 0;">
            <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"  EnableTheming="False"  GridLines="None"   Width="100%" CssClass="table_li table-border" OnPageIndexChanging="EGV_PageIndexChanging" OnRowCommand="EGV_RowCommand" >
               ...
               <%--     <asp:BoundField HeaderText="步骤序号" DataField="ProLevel" HeaderStyle-Width="8%"/>--%>
                    ...
                    <asp:BoundField HeaderText="处理人" DataField="HoneyName" HeaderStyle-Width="10%" />
