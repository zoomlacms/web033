<%@ page language="C#" autoeventwireup="true" inherits="MIS_OA_Struct_StructList, App_Web_25nqgink" masterpagefile="~/User/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
           ...
           <ZL:ExRepeater runat="server" ID="RPT" PageSize="10" PagePre="<tr><td><input type='checkbox' id='AllID_Chk'></td><td colspan='12'><div class='text-center'>" PageEnd="</div></td></tr>">
	        <ItemTemplate>
	          <tr ondblclick="location='UserInfo.aspx?id=<%# Eval("UserID") %>';">
		        ...
		        <td><%#Eval("UserID") %></td>
		        <td><a href="/user/Info/UserInfo.aspx?id=<%# Eval("UserID") %>" target="_blank"><%#Eval("HoneyName") %></a></td>
		        <td><%#Eval("WorkNum") %></td>
