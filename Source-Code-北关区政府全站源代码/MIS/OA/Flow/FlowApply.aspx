<%@ page language="C#" autoeventwireup="true" inherits="test_FlowApply_send, App_Web_gsp4p1da" masterpagefile="~/Common/Common.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<script>
    ...
    function UserFunc(json, select) {
        return Def_UserFunc(json, select);
    }
</script>
</asp:Content>
