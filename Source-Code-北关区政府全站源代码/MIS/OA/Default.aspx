<%@ page language="C#" autoeventwireup="true" inherits="MIS_ZLOA_Default, App_Web_rpzzopgu" masterpagefile="~/User/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div id="OAtop">
	...
	<li><a href="javascript:;" onclick="ShowMain('','Flow/ApplyList.aspx')"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-list-alt fa-stack-1x fa-inverse"></i></span><br />信息管理</a></li>
...
<div id="nav">
<ul class="nav_ull">
<li><a href="javascript:;" onclick="ShowMain('','/Mis/OA/Main.aspx');">OA首页</a></li>
<li><a href="javascript:;" onclick="ShowMain('','Flow/ApplyList.aspx?view=1');">待办事宜</a></li>
<%--<li><a href="#">日程安排</a></li>--%>
...
<li><a href="http://code.zoomla.cn/webOffice.rar">组件下载</a></li>              
</ul>
<ul class="nav_ulr">
...
<%--<li><a href="http://wei.zoomla.cn/" title="微应用" target="_blank"><i class="fa fa-weixin"></i></a></li>--%>
