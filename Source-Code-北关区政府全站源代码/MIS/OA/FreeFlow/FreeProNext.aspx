<%@ page language="C#" autoeventwireup="true" inherits="MIS_OA_Office_FreeProNext, App_Web_3g4ogugv" masterpagefile="~/User/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div id="Free_Div" runat="server" class="panel panel-primary" style="margin-top:10px;">
            ...
            <div class="panel-body" style="display:none;" id="select">
                ...
                <iframe id="User_IFrame" style="visibility: inherit; overflow: auto; overflow-x: hidden;width: 1000px;height:400px;"  name="main_right" src="/Common/Dialog/SelStructure.aspx?Type=AllInfo" frameborder="0"></iframe>
            </div>
        </div>
    </div>
    <style type="text/css">
