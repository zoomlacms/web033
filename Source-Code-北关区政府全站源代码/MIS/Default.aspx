<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Common/Master/Empty.master" inherits="MIS_Default, App_Web_t4j1ju5m" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<li><a href="javascript:void(0)" onClick="showd('t_pop_navli')"><i class="glyphicon glyphicon-option-horizontal"></i><br />更多</a></li>
</ul>
</div>  
...
<li class="j_ico_know"><a href=""><i class="glyphicon glyphicon-book"></i><br />知识</a></li>
...
<li class="j_ico_address"><a href=""><i class="glyphicon glyphicon-erase"></i><br />通讯录</a></li> 
