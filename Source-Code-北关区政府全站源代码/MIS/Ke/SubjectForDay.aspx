<%@ page language="C#" autoeventwireup="true" inherits="test_SubjectForDay, App_Web_13xqwovl" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="container-fluid">
        <div class="col-md-2">
            ...
            <div class="panel-heading">日程列表[<a href="SubjectForDay.aspx?type=-1">所有日程</a>] <span class="pull-right"><a href="javascript:;" title="添加日程" onclick="ShowTypeDiag()"><span class="glyphicon glyphicon-plus"></span></a></span></div>
