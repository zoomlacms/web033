<%@ page language="C#" autoeventwireup="true" inherits="test_SubjectForWeek, App_Web_13xqwovl" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-7">
          <ul class="nav navbar-nav dailyplan_nav">
            ...
            <li class="active"><a href="SubjectForWeek.aspx<%=Request.Url.Query %>"><span class="fa fa-calendar"></span> 周</a></li>
    ...
    <div class="container-fluid">
        <div class="col-md-2">
            ...
            <div class="panel-heading">日程列表[<a href="SubjectForWeek.aspx?type=-1">所有日程</a>]<span class="pull-right"><a href="javascript:;" title="添加日程" onclick="ShowTypeDiag()"><span class="glyphicon glyphicon-plus"></span></a></span></div>
        ...
        <table class="table table-bordered" id="DateTable">
            <thead id="DateTitle" runat="server">
                <tr>
                  <td colspan="8"><asp:LinkButton runat="server" CssClass="btn btn-primary" OnClick="PreWeek_Btn_Click" ToolTip="上一周"><i class="glyphicon glyphicon-chevron-left"></i></asp:LinkButton>
                    <strong style="font-size: 25px; position: relative; top: 4px;">
                    <asp:Label ID="DateSpan_L" runat="server"></asp:Label>
                    </strong>
                    <asp:LinkButton runat="server" CssClass="btn btn-primary" OnClick="NextWeek_Btn_Click" ToolTip="下一周"><i class="glyphicon glyphicon-chevron-right"></i></asp:LinkButton></td>
                </tr>
                <tr>
                  <td></td>
    ...
    <%--  <tr>
      ...
      <tr>
        <td colspan="2" style="text-align:center;"><asp:Button ID="Add_Btn" runat="server" Text="提交" CssClass="btn btn-primary" OnClientClick="return SetData()" OnClick="BtnAdd_Click"  ValidationGroup="Add" />
            <input type="button" class="btn btn-default" onclick="ViewTaskDetail()"  data-dismiss="modal"value="取消" />
        </td>
      </tr>
      <tr>
        <td></td>
