<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_ExTeacherManage, App_Web_13xqwovl" validaterequest="false" enableviewstatemac="false" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <ZL:ExRepeater ID="RPT" PageSize="20" PagePre="<tr><td><input type='checkbox' id='chkAll'/></td><td colspan='7'><div class='text-center'>" PageEnd="</div></td></tr>" runat="server">
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <a href="AddExTeacher.aspx?id=<%#Eval("ID")%>" class="option_style" title="修改"><i class="glyphicon glyphicon-pencil"></i></a> <a href="?menu=delete&id=<%#Eval("ID")%>" onclick="return confirm('确实要删除此教师吗？');" class="option_style" title="删除"><i class="fa fa-trash"></i></a>
                </td>
            </tr>
        </ItemTemplate>
