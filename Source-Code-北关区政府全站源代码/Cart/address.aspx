<%@ page language="C#" autoeventwireup="true" inherits="test_Cart_address, App_Web_tpgz2ygz" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox runat="server" class="form-control text_300" ID="Street_T" TextMode="MultiLine" /></td>
        </tr>
        <tr>
            <td class="text-right">邮政编码：</td>
            <td>
                <asp:TextBox runat="server" class="form-control text_300 num" ID="ZipCode_T" MaxLength="6" /></td>
        </tr>
        <tr>
            <td class="text-right">收货人姓名：</td>
            <td>
                <asp:TextBox runat="server" class="form-control text_300" ID="ReceName_T" /></td>
        </tr>
        <tr>
            <td class="text-right">手机号码：</td>
            <td>
                <asp:TextBox runat="server" class="form-control text_300 num" ID="MobileNum_T" MaxLength="13" /></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <label>
                    <asp:CheckBox runat="server" ID="Def_chk" />设置为默认收货地址</label></td>
        </tr>
        <tr>
            <td></td>
            <td>
