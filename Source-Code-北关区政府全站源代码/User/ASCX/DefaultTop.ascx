<%@ control language="C#" autoeventwireup="true" inherits="User_ASCX_DefaultTop, App_Web_zj2qda3w" %>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li id="nav_shop"><a href="/User/UserShop/ProductList.aspx">商城</a></li>
        <li id="nav_edu"><a href="/User/Exam/QuestList.aspx">教育</a></li> 
        <li id="nav_group"><a href="/Space/SpaceManage.aspx">聚合</a></li>
        <li id="nav_index"><a href="/User/UserZone/Default.aspx">社区</a></li>
