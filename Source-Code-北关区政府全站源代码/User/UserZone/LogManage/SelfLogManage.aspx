<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="SelfLogManage, App_Web_qv1yz3ji" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-striped table-bordered">
        <tr>
            <td style="width: 80%" bgcolor="#FFFFFF" valign="top">
                <ZL:ExGridView ID="gvLog" runat="server" AutoGenerateColumns="false" Width="100%" OnRowDataBound="gvLog_RowDataBound" GridLines="None" CellPadding="4" PageSize="2" DataKeyNames="ID" AllowPaging="True" OnPageIndexChanging="gvLog_PageIndexChanging">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
