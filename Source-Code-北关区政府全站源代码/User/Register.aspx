<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.User_Register, App_Web_hpmocupv" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
                        ...
                        <div class="border_right">
                            ...
                            <h1 class="text-center">注册会员</h1>
                                ...
                                <span class="d_err" id="CheckUserNameMessage"></span>
                                                ...
                                                <span id="Span1" runat="server" visible="false">用户名在
                            <asp:Literal ID="Literal2" runat="server"></asp:Literal>～<asp:Literal ID="Literal1" runat="server"></asp:Literal>个字符之间</span>
                                 ...
                                 <div class="col-lg-3 col-xs-12"></div>
                                    ...
                                    <li>
                                         <table style="width:100%;" border="0">
                                              <asp:Literal runat="server" ID="modelhtml"></asp:Literal>
                                        </table>
                                    </li>
                                </ul>
                                <ul>
                                    <li>
                                        <!--必填字段-->
                                        <table id="TableRegisterMust" runat="server" class="register_modeltable" style="width:100%;border:none;">
                                ...
                                <div class="reg_sub_t" onclick="SwicthSelectFill();" id="disable_btn"><i class="glyphicon glyphicon-grain"></i> 选填信息</div>
                                <ul class="list-unstyled"> 
                        	    <li>
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                <ContentTemplate>
                                                    <table style="border-collapse: collapse; display: none" id="TableRegisterSelect2"
                                                        name="TableRegisterSelect2" width="100%" border="0" class="selectFill">
                ...
                <asp:Panel ID="PnlStep3" runat="server" Visible="false">
                    <div class="reg">
                        <h1 class="text-center">
                            <span class="glyphicon glyphicon-user" style="font-size: 2em; margin-right: 10px; color: #00CCFF;"></span><span class="margin_l5">会员帐号信息</span></h1>
                        <%--第三步：注册结果--%>
                        <ul id="userinfo">
...
<script type="text/javascript">
    ...
    //后台调用
    function dispbtn() {
        var o = document.getElementById(btnId2);
        setTimeout(function () { o.disabled = true; $(o).css("color", "#808080"); }, 50);
    }
