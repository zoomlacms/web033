<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_UserShop_ProductList, App_Web_ah0xu1b0" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="container">
    ...
    <div class="us_topinfo btn_green" style="margin-top: 10px;">
     ...
     <%--           <asp:BoundField HeaderText="推荐" DataField="Dengji" HeaderStyle-Width="5%" />--%>
                ...
                <asp:TemplateField HeaderText="操作">
                    <HeaderStyle CssClass="td_m" />
                    <ItemTemplate>
                        <a href="/Store/Shopinfo.aspx?ID=<%#Eval("ID") %>" class="option_style" title="预览" target="_blank"><i class="fa fa-eye"></i></a>
                        <a href="AddProduct.aspx?menu=edit&ModelID=<%#Eval("ModelID") %>&NodeID=<%#Eval("Nodeid") %>&id=<%#Eval("id")%>" title="修改" class="option_style"><i class="glyphicon glyphicon-pencil"></i></a>
