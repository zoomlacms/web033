<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_ProductsSelect, App_Web_2lxysnmd" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <asp:Repeater ID="RPT" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center"><img src=" <%#getproimg()%>" style="width:50px;height:50px;"/></td>
