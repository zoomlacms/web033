<%@ page language="C#" autoeventwireup="true" inherits="User_Shop312_DeliverType, App_Web_ah0xu1b0" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
     ...
     <ZL:ExGridView ID="Egv" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" PageSize="10" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a runat="server" id="edit_btn" class="option_style" href='<%#"AddDeliverType.aspx?id="+Eval("id") %>'><i class="glyphicon glyphicon-pencil" title="修改"></i></a>
                    <asp:LinkButton CssClass="option_style" CommandName="Del" CommandArgument='<%# Eval("ID") %>' OnClientClick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');" runat="server"><i class="glyphicon glyphicon-trash" title="删除"></i></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
