<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableeventvalidation="false" inherits="Zoomla.Website.manage.Shop.AddProduct, App_Web_2lxysnmd" enableviewstatemac="false" masterpagefile="~/User/Default.master" viewStateEncryptionMode="Never" %>
...
<style>
    ...
    .modal_ifr{height:500px!important;}
    .footer_div{bottom:150px!important;}
</style>
<title>编辑商品</title>
</asp:Content>
   ...
   <table class="table table-striped table-bordered">
                    <tbody id="Tabs0" style="border-top:none;">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:HiddenField runat="server" ID="I_tem" />
                                <asp:HiddenField runat="server" ID="ComModelID"/>
                                <asp:HiddenField runat="server" ID="Bind_Hid"/>
                                <asp:HiddenField runat="server" ID="hidNum"/>
                            </td>
                        </tr>
                        <tr>
                       ...
                       <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="rd_red">*<asp:RequiredFieldValidator ID="RV1" runat="server"
                                    ControlToValidate="Proname" Display="Dynamic" ErrorMessage="商品名称不能为空!" SetFocusOnError="True" /></span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                               <div class="marginbot10">
                                ...
                                <table id="bindpro_table" style="display:none;" class="table table-striped table-bordered">
                                    <tr><td>ID</td><td>商品图片</td><td>零售价</td><td>商品名称</td></tr>
                                    <tbody id="bindpro_body"></tbody>
                                    <tr><td colspan="5">
                                            <input type="button" class="btn btn-primary" value="移除选定捆绑" onclick="RemoveBind();" />
                                        </td></tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span>千克（Kg）</span><asp:RegularExpressionValidator ID="RV12" runat="server" ControlToValidate="Weight" ErrorMessage="商品重量必须是数字!" ValidationExpression="^(-?\d+)(\.\d+)?$" SetFocusOnError="True" />
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <asp:View ID="View1" runat="server">
                                            <table id="tgTable" class="classdiv">
                                                ...
                                                <tr>
                                                    <td>最低团购人数：</td>
                                                    <td>
                                                        <asp:TextBox ID="NumberText" runat="server" class="form-control text_x" /><span>人</span>
                                                    </td>
                                                    <td>团购价格:</td>
                                                    <td>
                                                        <asp:TextBox ID="TGPrice" runat="server" class="form-control text_x" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>开始时间</td>
                                                    <td>
                                                        <asp:TextBox ID="ColonelStartTimetxt" runat="server" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" class="form-control"/>
                                                    </td>
                                                    <td>结束时间:</td>
                                                    <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="Sales_Chk" Text="打勾表示销售中，否则为停售状态" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <tbody id="Tabs2" style="border-top:none;display: none">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Producer" runat="server" class="form-control text_md"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Brand" runat="server" class="form-control text_md"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Rate" runat="server" Text="0" class="form-control text_x" />
                                <span>%</span>
                    ...
                    <tbody id="Tabs3" style="border-top:none;display: none">
                        <tr>
                            ...
                            <td>
                                 <asp:TextBox ID="ShiPrice" runat="server" class="form-control text_xs" Text="0" /><span>元</span>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="RV4" runat="server" ControlToValidate="LinPrice" ErrorMessage="零售价不能为空!" SetFocusOnError="True" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div id="userP" runat="server" style="display:none;">
                                    会员价：<asp:TextBox ID="userPrice" runat='server' class="form-control text_xs"/>元
                                            <asp:RegularExpressionValidator ID="RV9" runat="server" ControlToValidate="userPrice"
                                ...
                                <div id="divGroup" runat="server" style="display: none;">
                                    <asp:Repeater ID="repGroup" runat="server">
                                        <ItemTemplate>
                                            ...
                                            <%#Eval("GroupName")%>：<asp:TextBox ID="GroupPrice" runat='server' class="form-control text_xs"/>元
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtPoint" runat="server" Text="0" class="form-control text_x" /><span class="rd_green">仅用于计算提成</span>
                        ...
                        <tr>
                            <td><strong>运费设置：<a href="DeliverType.aspx">(前往配置)</a></strong></td>
                            <td><asp:RadioButtonList runat="server" ID="FareTlp_Rad" DataTextField="TlpName" DataValueField="ID" RepeatDirection="Horizontal" RepeatColumns="5"></asp:RadioButtonList></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtBookPrice"
                                    ErrorMessage="预订价格格式不正确!" ValidationExpression="\d+[.]?\d*" Display="Dynamic" SetFocusOnError="True" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><strong>打折优惠率:</strong></td>
                            <td>
                                <asp:TextBox ID="txtRecommend" runat="server" Text="0"  class="form-control text_x num" /><span>%</span>
                            </td>
                        </tr>
                        <tr>
                            <td><strong>允许单独销售：</strong></td>
                    ...
                    <tbody id="Tabs4" style="border-top:none;display: none">
                        <tr>
                            ...
                            <td>
                                <table width="100%" border="0">
                                    ...
                                    <tr>
                                        <td>&nbsp;买&nbsp;<asp:TextBox class="form-control text_xs" ID="ProjectPronum2" Text="1" runat="server"/>件此商品 可以送一件同样商品
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;买&nbsp;<asp:TextBox Text="1" ID="ProjectPronum3" class="form-control text_xs" runat="server"/>
                                            件此商品 可以送一件其他商品 赠品名称：<asp:TextBox ID="Productsname3" class="form-control text_md"
                                                runat="server"/><asp:Button
                                                    ID="Button6" class="btn btn-info" runat="server" Text="浏览..." OnClientClick="ProductsSelect('3');return false;" />
                                            <asp:HiddenField ID="HiddenField3" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;送&nbsp;<asp:TextBox ID="ProjectPronum4" class="form-control text_xs" runat="server" Text="1"/>件同样商品
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;送&nbsp;<asp:TextBox ID="ProjectPronum5" runat="server" class="form-control text_xs" Text="1"/>
                                    ...
                                    <tr>
                                        <td>&nbsp;加&nbsp;<asp:TextBox ID="ProjectMoney6" class="form-control text_xs" runat="server" Text="1"/>元钱送商品 送一件赠品名称：<asp:TextBox ID="Productsname6" runat="server"
                                                class="form-control text_md"/><asp:Button
                                                    ID="Button8" runat="server" class="btn btn-info" Text="浏览..." OnClientClick="ProductsSelect('6');return false;" />
                                            <asp:HiddenField ID="HiddenField6" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;满&nbsp;<asp:TextBox ID="ProjectMoney7" runat="server" Text="1" class="form-control text_xs"/>元钱送商品 送一件赠品名称：
                                            <asp:TextBox ID="Productsname7" class="form-control text_md" runat="server"/><asp:Button
                                                    ID="Button5" class="btn btn-info" runat="server" Text="浏览..." OnClientClick="ProductsSelect('7');return false;" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="Button9" class="btn btn-info" runat="server" Text="绑定其他促销方案" Width="261px"
                                ...
                                <br />
                                <asp:Button ID="Button10" class="btn btn-info" runat="server" Text="删除选中方案" Width="260px"
                        ...
                        <tr>
                            ...
                            <td>购买&nbsp;<asp:TextBox ID="IntegralNum" runat="server" Text="1" class="form-control text_xs"/>&nbsp;件此商品可以得到
                            <asp:TextBox ID="Integral" runat="server" Width="53px" class="form-control" MaxLength="3" />
                            <span>积分</span>   
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator16" runat="server"
                                ControlToValidate="Integral" ErrorMessage="积分只能是数字或小数!" ValidationExpression="^\d+\.?\d+$|^\d+$" />
                            </td>
                        </tr>
                    </tbody>
    ...
    <div class="text-center Conent_fix footer_div btn_green">
        <input type="button" class="btn btn-primary" value="保存商品信息" onclick="PreSubmit();" />
        ...
        <a href="ProductList.aspx" class="btn btn-primary" id="Button2">返回列表<i class="fa fa-arrow-circle-up"></i></a>
    </div>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script type="text/JavaScript">
        ...
        function BindPro(projson) {
            ...
            var proattr = JSON.parse($("#Bind_Hid").val());
            var trtlp = "<tr class='td_binddata'><td class='td_s'><label><input type='checkbox' name='bind_chk' value='@id'>@id</label></td><td class='td_m'><img onerror=\"this.src='/UploadFiles/nopic.gif'\" style='width:60px;height:45px;' src='/@Thumbnails' /></td><td class='td_m'>@LinPrice</td><td>@Proname</td></tr>";
        ...
        function OpenSelect() {
            ...
            diag.maxbtn = false;
            diag.width = "none";
            diag.url = "/Common/AddbindPro.aspx?id=<%:ProID %>&filter=user";
            diag.ShowModal();
            return false;
        }
