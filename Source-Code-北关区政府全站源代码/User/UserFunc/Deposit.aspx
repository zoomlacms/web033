<%@ page language="C#" autoeventwireup="true" inherits="User_UserFunc_Deposit, App_Web_n4dn1fqf" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                    ...
                    <table class="table table-bordered">
                        <tr>
                            <td><span>充值金额:</span>
                                ...
                                <asp:Button runat="server" ID="Mone_Btn" CssClass="btn btn-primary" Text="确认充值" OnClick="Mone_Btn_Click" OnClientClick="return CheckMoney();" Visible="false" />
                                <input type="button" value="确定充值" onclick="CheckMoney();" class="btn btn-primary" id="money_btn" />
                            </td>
                        </tr>
                    </table>
                    <div class="alert alert-info">
                        <div>*为了您的资金安全,平台限制每笔入金最低$100.00,最高$10000.00</div>
                        <div class="margin_t5">*系统将按6.3汇率转为人民币支付</div>
                    </div>
                </div>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script>
        ...
        function CheckMoney() {
            ...
            else if (parseInt(val) < 100 || isNaN(parseInt(val))) { alert("充值金额最少为100美金"); }
            else if (parseInt(val) > 10000) { alert("充值金额不能超过10000美金"); }
            else { flag = true; }
            if (flag)
            {
