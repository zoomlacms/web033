<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Message_Mobile, App_Web_wtdjerdd" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="container margin_t10">
    <div class="us_seta">
        <table class="table table-bordered table-hover table-striped">
            ...
            <tr align="center" class="tdbg btn_green">
