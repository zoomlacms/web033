<%@ page language="C#" autoeventwireup="true" masterpagefile="~/User/Default.master" inherits="User_Order_ReqRepair, App_Web_npreebtu" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="container reqrepair">
        <table class="table table-striped protable">
            ...
            <tr>
                <td class="proinfo_td">
                    <div class="col-md-2"><img src="/UploadFiles/nopic.gif" runat="server" id="ProImgSrc" style="width:100%;height:80px;" /></div>
