<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.RegisterCheck, App_Web_hpmocupv" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<form id="form1" runat="server">
   <div id="main_l" class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center main_ldiv" style="padding:0 5px;" >
   	<h1 class="text-left"><span class="glyphicon glyphicon-user pull-left"></span>注册会员认证</h1>
