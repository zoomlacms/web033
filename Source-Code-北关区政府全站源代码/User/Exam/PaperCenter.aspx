<%@ page language="C#" autoeventwireup="true" inherits="User_Exam_PaperCenter, App_Web_n2hb2ngt" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div runat="server" id="addsucc_div" class="panel panel-primary" visible="false">
       ...
       <div class="panel-footer" style="padding-left: 120px;">
            <a href="" runat="server" id="paper_view" class="btn btn-primary">查看试卷</a>
            <a href="" runat="server" id="paper_down" class="btn btn-primary" target="_blank">下载试卷</a>
...
<asp:Content runat="server" ContentPlaceHolderID="Script">
    ...
    <script>
        ...
        function UPFunc(p_id) {
            ...
            console.log(item.attr("id") + ":" + pre.length);
        ...
        function PreSave() {
            ...
            $("#Qids_Hid").val(JSON.stringify(list));
        }
    </script>
</asp:Content>