<%@ page language="C#" autoeventwireup="true" inherits="User_Questions_ExamDetail, App_Web_n2hb2ngt" enableviewstatemac="false" validaterequest="false" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="panel panel-primary" ng-app="app">
    <div class="panel-heading">
        ...
        <span><i class="glyphicon glyphicon-time"></i><span id="time_sp" runat="server" class="margin_l5" data-time="0"></span></span>
        <div class="uinfo_div">
