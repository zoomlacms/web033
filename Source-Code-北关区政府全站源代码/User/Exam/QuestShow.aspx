<%@ page language="C#" autoeventwireup="true" masterpagefile="~/User/Default.master" inherits="User_Exam_QuestShow, App_Web_n2hb2ngt" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="container">
    <table class="table table-striped table-bordered table-hover" ng-app="app">
        ...
        <tr>
            <td>试题内容:</td>
            <td>
                <asp:Literal ID="Content_Li" EnableViewState="false" runat="server"></asp:Literal>
            </td>
        </tr>
        <tr>
            <td>分数:</td>
    ...
    <asp:HiddenField ID="Answer_Hid" runat="server" />
</asp:Content>
