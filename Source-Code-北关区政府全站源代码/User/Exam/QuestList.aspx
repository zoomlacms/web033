<%@ page language="C#" autoeventwireup="true" inherits="User_Exam_QuestList, App_Web_n2hb2ngt" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <ZL:ExGridView ID="EGV" runat="server" DataKeyNames="Tagkey" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" EnableTheming="False" IsHoldState="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="试题标题">
                        <ItemTemplate>
                            <a href="AddEngLishQuestion.aspx?p_id=<%#Eval("p_id") %>"><%# GetTitle()%></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="相关操作" ItemStyle-VerticalAlign="Middle">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton runat="server" ID="editbtn" CommandName="edit2" CommandArgument='<%#Eval("p_id") %>' Visible="false" ToolTip="修改"><span class="glyphicon glyphicon-pencil"></span></asp:LinkButton>
                            <asp:LinkButton runat="server" ID="delbtn" CommandName="del2" CommandArgument='<%#Eval("p_id") %>' OnClientClick="return confirm('确定要删除吗?');" Visible="false" ToolTip="删除"><span class="glyphicon glyphicon-trash"></span></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </ZL:ExGridView>
