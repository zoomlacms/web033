<%@ page language="C#" autoeventwireup="true" masterpagefile="~/User/Empty.master" inherits="Manage_Exam_KnowledgeManage, App_Web_n2hb2ngt" enableEventValidation="false" viewStateEncryptionMode="Never" %>
 ...
 <div class="input-group text_300">
     <asp:TextBox ID="Search_T" runat="server" placeholder="知识点" CssClass="form-control"></asp:TextBox>
      <span class="input-group-btn">
          <asp:LinkButton ID="Search_Btn" runat="server" CssClass="btn btn-primary" OnClick="Search_Btn_Click"><i class="glyphicon glyphicon-search"></i></asp:LinkButton>
      </span>
    </div>
