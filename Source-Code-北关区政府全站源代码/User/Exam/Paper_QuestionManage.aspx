<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Paper_QuestionManage, App_Web_n2hb2ngt" enableviewstatemac="false" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script type="text/javascript">
        ...
        function SelQuestion() {
            diag.title = "选择题目";
            diag.url = "SelQuestion.aspx?pid=<%=Pid %>&selids=" + $("#SelIDS_IDS").val();
            diag.maxbtn = false;
            diag.ShowModal();
        }
        function CLoseDIag() {
