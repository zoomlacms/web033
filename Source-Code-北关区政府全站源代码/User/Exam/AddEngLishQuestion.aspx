<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="manage_Question_AddEngLishQuestion, App_Web_n2hb2ngt" enableviewstatemac="false" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<li><a href="QuestList.aspx?NodeID=<%=NodeID %>">试题管理</a></li>
<li class="active">添加试题 <asp:Label id="CurNode_L" runat="server"></asp:Label></li>
</ol>
</div>
<div class="container">
    ...
    <table class="table table-striped table-bordered table-hover tab-content">
        <tbody id="basic" class="tab-pane active">
            ...
            <tr id="nodetr" runat="server" style="display:none;">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody ng-repeat="item in list|orderBy:'-orderid'">
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:;" ng-click="remove(item.p_id);" title="移除"><span class="glyphicon glyphicon-remove"></span></a>
                                        <a href="javascript:;" ng-click="edit(item.p_id);" title="修改"><span class="glyphicon glyphicon-pencil"></span></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
