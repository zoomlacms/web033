<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_QuestionManage, App_Web_n2hb2ngt" enableviewstatemac="false" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="tab-content col-lg-2 col-md-2 col-xs-2 col-sm-2 padding0">
            ...
            <div class="tab-pane treediv" id="keyPanel">
                <div class="input-group text_md" style="margin-left:10px;">
                  <input type="text" id="knowname_t" onkeydown="EndterSearch()" class="form-control" placeholder="知识点">
                  <span class="input-group-btn">
                    <button class="btn btn-default" type="button" onclick="SearchKnows()"><span class="glyphicon glyphicon-search"></span></button>
                  </span>
                </div>
                <ul id="knows_ul" class="margin_t5">
                    <li id="knows_li"><span class="glyphicon glyphicon-list treeicon"></span><a data-val='0' href='javascript:;'>全部</a></li>
                </ul>
            </div>
        </div>
        <div class="col-lg-8 col-md-8 col-xs-8 col-sm-8">
                ...
                <tr><td>难度</td><td>
                    <ul class="sel_ul filter" data-type="diffcult">
                        ...
                        <li data-val="3"><a href="javascript:;">偏难</a></li>
                        <li data-val="4"><a href="javascript:;">极难</a></li>
                    </ul></td></tr>
                <tr><td>年级</td><td>
