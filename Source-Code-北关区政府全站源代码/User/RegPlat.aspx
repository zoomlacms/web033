<%@ page language="C#" autoeventwireup="true" inherits="User_RegPlat, App_Web_hpmocupv" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
<title>用户注册</title>
...
<h1 class="regplat_title">连接世界的力量</h1>
    ...
    <a href="/User/Login.aspx"><i class="glyphicon glyphicon-menu-left"></i>返回登录</a><br />
