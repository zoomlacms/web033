<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="User_login, App_Web_hpmocupv" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html lang="zh-CN">
<head runat="server">
<meta charset="utf-8">
...
<center style="background:url(http://code.zoomla.cn/user_login.jpg);background-position: center;left:0;top:0;right:0;bottom:0; position: absolute; background-repeat:no-repeat;background-size:cover;">
    ...
    <div class="login_type_div">
        <div><a id="EMail_A" href="login.aspx?RegID=1" runat="server"><span class="glyphicon glyphicon-envelope"></span> 邮箱登录</a></div>
        <div><a id="ID_A" runat="server" href="login.aspx?RegID=2"><span class="glyphicon glyphicon-info-sign"></span> ID登录</a></div>
        <div><a id="User_A" runat="server" href="login.aspx"><span class="glyphicon glyphicon-user"></span> 用户登录</a></div>
    </div>
    </div>
</center>
</form>
