<%@ page language="C#" autoeventwireup="true" inherits="User_Content_FileBuyManage, App_Web_vtyde5mw" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<ItemTemplate>
<a target="_blank" href="/Common/Label/DownFile.aspx?ranstr=<%#Eval("Ranstr") %>&Gid=<%#Eval("Gid") %>&Field=<%#Eval("Field") %>"><span class="glyphicon glyphicon-save"></span>下载</a>
</ItemTemplate>
</asp:TemplateField>
</Columns>
</ZL:ExGridView>
