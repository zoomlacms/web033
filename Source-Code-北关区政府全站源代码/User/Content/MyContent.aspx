<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Content.MyContentpage, App_Web_vtyde5mw" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="us_pynews btn_green margin_t10">
    <div class="us_seta">
        ...
        <div style="width:100%; float: left; line-height: 30px;"">
            ...
            <asp:Button ID="Rel_Btn" Visible="false" runat="server" Text="批量还原" CssClass="btn btn-primary pull-left" style="margin-left:5px;" OnClick="Rel_Btn_Click" />
