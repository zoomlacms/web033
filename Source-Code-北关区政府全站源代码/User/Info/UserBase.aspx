<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Info_UserBase, App_Web_xov4zm55" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<style> 
.cutImg{width:1100px;}#prefile_img{display:none!important;}
</style>
</asp:Content>
...
<tbody id="Tabs0">
<tr>
<td id="pro_td" colspan="4" >
     <ZL:UserBar Width="300" ID="UserBar_U" runat="server" />
</td>
</tr>
...
<tr>
<td class="text-right">真实姓名：
</td>
<td style="text-align: left">
<asp:TextBox ID="tbTrueName" CssClass="form-control text_md " runat="server"></asp:TextBox>
</td>
<td style="text-align: right">昵称：
</td>
<td style="">
<asp:TextBox ID="txtHonName" CssClass="form-control text_md " runat="server"></asp:TextBox>
</td>
</tr>
<tr>
...
ControlToValidate="tbFax" CssClass="tips" ErrorMessage="只能输入整数"></asp:RegularExpressionValidator>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="tbAddress" CssClass="form-control text_md" runat="server"></asp:TextBox>
        </td>
    </tr>
<tr>
...
<td style="text-align: right">MSN帐号：
</td>
<td style="">
...
<td style="text-align: right">UC帐号：
</td>
<td style="">
...
<script type="text/javascript" src="/JS/ZL_Content.js"></script>
    <script>
		...
		$().ready(function(e) {
            ...
            ////统计用户字段完成度
			//var fieldcount = parseInt($("#UserFieldCount_Hid").val());
			//if (fieldcount >= 0) {
			//    $("#pro_td .progress-bar").css('width', fieldcount + "%");
			//    $("#protext_span").text(fieldcount + "%");
			//} else { $("#pro_td").hide(); }
		});
    </script>
</asp:Content>