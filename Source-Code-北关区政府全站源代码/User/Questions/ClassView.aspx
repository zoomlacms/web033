<%@ page language="C#" autoeventwireup="true" inherits="User_Exam_ClassView, App_Web_mbm2rqe2" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div>
        <div class="input-group text_400" style="margin:auto;">
          ...
          <span class="input-group-btn">
              <asp:LinkButton ID="Search_Btn" runat="server" OnClick="Search_Btn_Click" CssClass="btn btn-default"><span class="glyphicon glyphicon-search"></span></asp:LinkButton>
          </span>
        </div>
    </div>
    ...
    <div class="emptydata_div" id="emptydata_div" visible="false" runat="server">
        <div class="tips_div">
            <h2><span class="glyphicon glyphicon-education"></span> 没有找到相关班级!</h2>
        </div>
    </div>
