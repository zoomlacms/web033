<%@ page language="C#" autoeventwireup="true" inherits="Plugins_PicEdit_CutPic_User, App_Web_3rivzrio" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <div class="colo-lg-3 col-md-3 col-sm-4 col-xs-5 padding5" id="imgLeftFunc">
                    <div class="tab-content">
                        <div class="tab-pane active" id="imgCut">
                            <div class="imgTextItem">
                                <ul class="list-unstyled" role="menu">
                                    ...
                                    <li><span>宽</span><input id="width_t" type="text" class="form-control">px</li>
                                    <div class="clearfix"></div>
                                    <li><span>高</span><input id="height_t" type="text" class="form-control">px</li>
                                    <li><span class="pull-left">
                                        <%--    <asp:RadioButton runat="server" Text="约束比例" />--%></span>
                                        <span class="pull-right">
                                            <input type="button" class="btn btn-default" onclick="ApplyCut();" value="应用裁剪" /></span>
                                    </li>
                                    <div class="clearfix"></div>
                                    <li class="divider"></li>
                                    <li>
                        ...
                        <div class="tab-pane" id="imgSmall">
                            <div class="imgTextItem">
                                <ul class="list-unstyled" role="menu">
                                    ...
                                    <li><span>宽</span><input type="text" id="zoom_width_t" class="form-control" /><span>px</span>
                                    </li>
                                    <div class="clearfix"></div>
                                    <li><span>高</span><input type="text" id="zoom_height_t" class="form-control" /><span>px</span></li>
                                    <li><span class="pull-left" title="保持初始宽高比,避免图片变形">
                                        <label>
                                            <input type="checkbox" id="scaled_chk" checked="checked" />约束比例</label></span>
                                        <span class="pull-right">
                                            <input type="button" class="btn btn-default" onclick="ZoomFunc();" value="缩放图片" /></span>
                                    </li>
                                    <div class="clearfix"></div>
                                    <li class="divider"></li>
                                    <li>
                        ...
                        <div class="tab-pane padding5" id="imgWord">
                            <h4>文字水印</h4>
                            <input type="button" value="样式选择" onclick="ShowFontStyle();" class="btn btn-default" />
                            ...
                            <div class="divider" style="margin-top: 5px; margin-bottom: 5px;"></div>
                            <span class="pull-right">
                                <input type="button" class="btn btn-default" onclick="AddFontWater();" value="添加文字水印"></span>
                        </div>
                    </div>
...
<asp:Content runat="server" ContentPlaceHolderID="Script">
    ...
    <style>
        ...
        #slideProgress {
            width: 30px;
            height: 30px;
            background: url(css/arrow-right.png);
    ...
    <script type="text/javascript">
        ...
        var pval = <%=string.IsNullOrEmpty(Request["pval"])? "{}" :Request["pval"]%>//父页面传递的Json
            ...
            function ApplyCut() {
                ...
                x1 = cursele.x1;
                y1 = cursele.y1;
                xwidth = cursele.width;
                yheight = cursele.height;
                $.post("CutPic.aspx", { action: "crop", x1: x1, y1: y1, width: xwidth, height: yheight, vpath: $("#photo").attr("src") }, function (url) {
