<%@ page language="C#" autoeventwireup="true" inherits="MIS_OA_Flow_office, App_Web_kwy1cfz4" masterpagefile="~/User/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <style type="text/css">
        .exdiv {display: none; width: 350px; }
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
            <div>
                <asp:DropDownList runat="server" ID="Head_DP" DataValueField="WordPath" DataTextField="ModelName" CssClass="form-control text_md" onchange="AddRedHead();"></asp:DropDownList>
                <asp:DropDownList runat="server" ID="Sign_DP" DataTextField="SignName" DataValueField="ID" CssClass="form-control text_md" onchange="AddSign();" Enabled="false"></asp:DropDownList>
            </div>
            <div class="divline"></div>
            <div class="panel panel-primary exdiv" id="signcheck_div">
                <div class="panel-heading"><span class="glyphicon glyphicon-pawn"></span><span class="margin_l5">请输入签章密码</span></div>
                <div class="panel-body">
                    <input type="text" class="form-control text_300" style="margin-bottom: 5px;" id="signpwd_t" />
                    <input type="button" class="btn btn-primary" value="确认" onclick="SignPwdCheck();" />
                    <input type="button" class="btn btn-default" value="取消" onclick="$('#signcheck_div').hide();" />
                </div>
            </div>
            <div class="panel panel-primary " id="signedlist_div">
                <div class="panel-heading"><span class="glyphicon glyphicon-pawn"></span><span class="margin_l5">已有签章</span></div>
                <div class="panel-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="item_img_div">
                                                    <img class="tdimg200" src="<%#Eval("VPath") %>" /></div>
                                            </td>
                                            <td><%#Eval("CUName") %></td>
