<%@ page language="C#" autoeventwireup="true" inherits="App_CreateLink, App_Web_x4ib2cqz" masterpagefile="~/Common/Commenu.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
 ...
 <div class="container">
      <div class="col-md-7 col-lg-7">
           <table class="table table-bordered table-striped">
            ...
            <%--   <tr><td>别名：</td><td><asp:TextBox runat="server" ID="Alias_T" CssClass="form-control text_300" /></td></tr>--%>
