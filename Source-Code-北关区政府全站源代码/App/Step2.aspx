<%@ page language="C#" autoeventwireup="true" inherits="App_Step2, App_Web_tc2qzxm2" masterpagefile="~/Common/Commenu.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <div runat="server" id="noauth_div" visible="false" class="margin_t10">
                    <ul class="list-unstyled" id="optionul">
                        ...
                        <div class="opmenu" style="background: rgb(153, 153, 255);" title="开始学习">
                                <a target="_blank" href="https://www.zoomla.cn/PhoneGap/">
                        ...
                        <li><div class="opmenu" style="background: rgb(102, 153, 51);" title="点击访问">
                            <a target="_blank" href="http://www.zoomla.cn/server">
