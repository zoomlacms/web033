<%@ page language="C#" autoeventwireup="true" inherits="Design_Editor_Editor, App_Web_qh34y4hb" enableviewstate="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
...
<meta http-equiv="X-UA-Compatible" content="IE=edge" />
    ...
    <style type="text/css">
        * {font-family:'Microsoft YaHei';}
        ...
        .candrag,.onlydrag,.onlyresize {cursor:move;border:2px solid rgba(0, 0, 0, 0.00);display:inline-block;}
