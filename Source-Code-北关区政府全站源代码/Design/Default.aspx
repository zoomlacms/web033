<%@ page language="C#" autoeventwireup="true" inherits="Design_Default, App_Web_bas0j3rg" enableviewstate="false" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<script>
        ...
        function CloseDiag()
        {
            comdiag.CloseModal();
            lgDiag.CloseModal();
            try{ IfrHelper.getIfrObj().CloseDiag();}catch(ex){}
        }
