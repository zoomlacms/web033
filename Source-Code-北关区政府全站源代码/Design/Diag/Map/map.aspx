<%@ page language="C#" autoeventwireup="true" inherits="Design_Diag_Map_map, App_Web_fyuf3exk" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Script">
    ...
    <script>
        ...
        maphelper.GetCurPos(function (r) {
            ...
            map.panTo(r.point);
            //弹出信息窗口的事件了
            //var infoWindow = new BMap.InfoWindow("<a target='_blank' href='www.zoomla.cn'>详情</a>");  // 创建信息窗口对象
