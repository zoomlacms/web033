<%@ page language="C#" autoeventwireup="true" inherits="Design_Diag_Common_Edit, App_Web_4iy4ijsa" masterpagefile="~/Design/Master/Edit.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="panel panel-primary">
       ...
       <div class="panel-body" style="padding-left:0px;padding-right:0px;padding-top:0px;">
           ...
           <hr class="divider-long"/>
           <div class="setting-row">
               <div><label class="row-title">字体选择</label></div>
