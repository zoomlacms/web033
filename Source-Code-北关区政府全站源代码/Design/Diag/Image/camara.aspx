<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Common/Common.master" inherits="test_testcamara, App_Web_yo4fh4ns" enableEventValidation="false" viewStateEncryptionMode="Never" %>
          ...
          <div class="panel-body">
            ...
            <div class="phototools">
                <div class="col-sm-4 col-xs-4 col-md-4 col-lg-4">
                    <a class="preimg_a" href="/Images/userface/noface.gif"><img class="preimg" src="/Images/userface/noface.gif" /></a>
                </div>
                ...
                <div class="col-sm-4 col-xs-4 col-md-4 col-lg-4 text-right">
                    <a href="javascript:;" title="确认" onclick="SaveImg()"><span class="glyphicon glyphicon-ok-circle" style="font-size:50px;color:white;"></span></a>
                </div>
            </div>
          </div>
        </div>
