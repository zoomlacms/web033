<%@ page language="C#" autoeventwireup="true" inherits="Design_Diag_AddComp, App_Web_pw4ihqgh" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <ul class="category-list"  style="min-height:500px;position:fixed;left:0px;">
        ...
        <div id="compview" class="category-view-wrapper" style="padding-bottom:50px;margin-left:75px;"></div>
    </div>
       </asp:Content>
           ...
           $(".category").click(function () {
               ...
               $("#compview").load("/Design/Diag/" + type + "/Add.html?m=" + Math.random(), function () {
                   ...
                   $(".domItem").click(function () {
                       var model = GetModel(this); parent.AddComponent(model);
                   });
               });
           });
