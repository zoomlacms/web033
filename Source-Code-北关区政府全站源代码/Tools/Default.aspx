<%@ page language="C#" autoeventwireup="true" inherits="Tools_Default, App_Web_svhscjti" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div id="config_div" runat="server">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr><td>关闭HTTPS</td><td><asp:Button runat="server" ID="Close_Btn" Text="关闭HTTPS" OnClick="Close_Btn_Click" /></td></tr>
