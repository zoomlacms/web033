<%@ page language="C#" masterpagefile="~/User/Empty.master" autoeventwireup="true" inherits="Tools_Default, App_Web_zdukazb0" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<input type="text" name="Skey" id="Skey" class="form-control" placeholder="http://www.zoomla.cn" onkeydown="return IsEnter(this);"/>
