<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.I.Pay.PaymentList, App_Web_1wpl4xu0" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-striped table-bordered table-hover">
        <tr>
            ...
            <td>发起时间</td>
            <td><asp:LinkButton ID="DateAsc" OnClick="DateAsc_Click" runat="server">完成时间<span class="glyphicon glyphicon-arrow-up"></span></asp:LinkButton></td><td>操作</td>
        </tr>
        <ZL:ExRepeater ID="RPT" runat="server" OnItemCommand="RPT_ItemCommand" PageSize="20" PagePre="<tr><td><input type='checkbox' id='chkAll'/></td><td colspan='12'><div class='text-center'>" PageEnd="</div></td></tr>">
        <ItemTemplate>
            <tr>
                <td>
                ...
                <td>
                    <asp:LinkButton runat="server" CommandName="Del" OnClientClick="return confirm('是否确定删除?')" CommandArgument='<%#Eval("PaymentID") %>' CssClass="option_style"><i class="fa fa-trash-o" title="删除"></i></asp:LinkButton>
