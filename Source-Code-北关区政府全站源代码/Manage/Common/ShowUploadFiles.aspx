<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Common.ShowUploadFiles, App_Web_2otx5sdp" masterpagefile="~/Common/Common.master" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
	...
	<asp:Repeater ID="RptFiles" runat="server" OnItemCommand="RptFiles_ItemCommand">
		...
		<ItemTemplate>                
			<tr class="tdbg" align="center">
				...
				<td align="left">
					<%# System.Convert.ToInt32(Eval("type")) == 1 ? "<span class='glyphicon glyphicon-folder-close'></span>" : "<span class='glyphicon glyphicon-file'></span>"%>
