<%@ page language="C#" autoeventwireup="true" inherits="test_GetNews, App_Web_gb3yd2ie" masterpagefile="~/User/Empty.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
             ...
             <ul class="tul col-lg-12 col-md-12">
                 <li style="line-height:40px;font-size:14px;">
                    <span id="<%#((AnalyModel)Container.DataItem).Skey %>_sp">
                     关键词:<span class="rd_red"><%#((AnalyModel)Container.DataItem).Skey %></span>总计:<%#(Container.DataItem as AnalyModel).CollCount %>新闻:<%#(Container.DataItem as AnalyModel).FromNews %>微博:<%#(Container.DataItem as AnalyModel).FromBlog %>微信:<%#(Container.DataItem as AnalyModel).FromWx %>
                    </span>
