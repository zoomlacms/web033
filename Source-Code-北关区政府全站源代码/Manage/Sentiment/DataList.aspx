<%@ page language="C#" autoeventwireup="true" inherits="Manage_Sentiment_DataList, App_Web_gb3yd2ie" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="false" PageSize="10" OnRowCommand="EGV_RowCommand"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a href="<%#Eval("Link") %>" title="点击浏览" target="_blank" class="option_style"><i class="glyphicon glyphicon-globe"></i></a>
