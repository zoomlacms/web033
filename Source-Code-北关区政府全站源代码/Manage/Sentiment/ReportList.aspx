<%@ page language="C#" autoeventwireup="true" inherits="Manage_Sentiment_ReportList, App_Web_gb3yd2ie" masterpagefile="~/User/Empty.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" EnableTheming="False" CssClass="table table-striped table-bordered table-hover" EmptyDataText="当前没有信息!!" OnPageIndexChanging="EGV_PageIndexChanging">
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        <a href="/UploadFiles/Report/<%#Eval("Name") %> " class="option_style"><i class="glyphicon glyphicon-download-alt"></i>下载</a>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Left" />
                </asp:TemplateField>
            </Columns>
