<%@ page language="C#" autoeventwireup="true" validaterequest="false" masterpagefile="~/Manage/I/Default.master" inherits="Manage_Shop_SetOrderStatus, App_Web_rfihykcf" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="tab-pane" id="PayStatus">
        ...
        <table class="table table-bordered table-hover margin_t5">
            ...
            <div class="alert alert-info" role="alert">
                <span class="glyphicon glyphicon-info-sign"></span> "预付款"编辑状态可使用@money表示预付款的值!
            </div>
    </div>
    ...
    <script>
        ...
        function InitSelColor() {
            $('.colortext').each(function () {
                $(this).parent().append(' <a href="javascript:;" class="selcolor" title="颜色选择"><span class="glyphicon glyphicon-text-color"></span></a>');
            });
