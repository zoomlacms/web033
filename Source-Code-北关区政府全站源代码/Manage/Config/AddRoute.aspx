<%@ page language="C#" autoeventwireup="true" inherits="Manage_Config_AddRoute, App_Web_rfihykcf" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-bordered">
        <tr>
          ...
          <td><asp:DropDownList runat="server" ID="SType_DP" CssClass="form-control text_300">
              ...
              <asp:ListItem Value="2">在线设计_域名路由</asp:ListItem>
            </asp:DropDownList></td>
        </tr>
        <tr>
          <td>域名</td>
          <td><div class="input-group"> <span class="input-group-addon">http://</span>
           ...
           <span class="rd_green">必须解析到网站服务器并开放80端口独占状态,示例:club.zoomla.cn</span>
          </td>
        </tr>
        <tr>
          <td>指向</td>
          <td><asp:TextBox runat="server" ID="Url_T"  CssClass="form-control text_300" data-enter="2" placeholder="域名路由该项可为空"/>
            <span class="rd_green">示例:/Guest/Bar/</span></td>
        </tr>
        <tr><td>关联用户</td><td>
