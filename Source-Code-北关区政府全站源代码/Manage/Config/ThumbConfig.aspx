<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Config_ThumbConfig, App_Web_rfihykcf" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <tr  runat="server" id="oox" >
      ...
      <td> 
          X：<asp:TextBox ID="PX" runat="server" Width="50"></asp:TextBox>
        <span>像素 填写的数据必须是数字！设为手动才可启用改参数</span><br />
        Y：<asp:TextBox ID="PY" runat="server" Width="50"></asp:TextBox><span>像素</span></td>
    </tr>
  </table>
