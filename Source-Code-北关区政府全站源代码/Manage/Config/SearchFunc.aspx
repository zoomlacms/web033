<%@ page language="C#" autoeventwireup="true" inherits="manage_Search_SearchFunc, App_Web_rfihykcf" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="alert alert-info">
        管理导航：在此位置您可以对索引目录进行观察位置、删除目录及管理目录的索引文件。 <span style="color:red">(注：凡是文件未启用或站内链接不存在该文件则无法链接到指定的页面。)</span>
    </div> 
    <ul class="nav nav-tabs" id="linktype_ul">
      <li data-id="0" role="presentation"><a href="SearchFunc.aspx">所有应用</a></li>
      <li data-id="1" role="presentation"><a href="SearchFunc.aspx?state=1">已启用</a></li>
      <li data-id="2" role="presentation"><a href="SearchFunc.aspx?state=2">已停用</a></li>  
    </ul>
    <div>
    ...
    <div class="text-center">
        ...
        <asp:Button ID="Button3" runat="server" Text="保存排序" CssClass="btn btn-primary" OnClick="saveOrder_Btn_Click" OnClientClick="return confirm('确定要保存修改后的排序吗!!!');"/>
    </div>
     <style>
