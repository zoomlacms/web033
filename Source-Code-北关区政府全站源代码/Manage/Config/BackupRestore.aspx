<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_BackupRestore, App_Web_rfihykcf" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div runat="server" id="maindiv" visible="false">
        ...
        <ul class="nav nav-tabs">
            ...
            <li><a href="#tab1" data-toggle="tab"><i class="glyphicon glyphicon-folder-open"></i> 文件备份</a></li>
        </ul>
