<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="ZoomLa.WebSite.Manage.Config.UserConfig, App_Web_rfihykcf" validaterequest="false" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" viewStateEncryptionMode="Never" %>
...
<li ><a href="#tab5" data-toggle="tab" onclick="show1(5)">扩展配置</a></li>
...
<table class="table table-striped table-bordered table-hover myform-control">
	<tbody id="Tabs0">
		<tr>
			<td style="width:30%;"><strong>是否开启会员注册：</strong></td>
			<td>
		...
		<tr>
			...
			<td><input type="checkbox" runat="server" id="radioMobile" class="switchChk" /></td> 
		</tr>
        <tr><td><strong>手机校验码位数：</strong></td><td>
            <asp:TextBox runat="server" ID="MobileCodeNum_T" CssClass="form-control text_md int" MaxLength="2" /><span>个字符</span>
            <span class="rd_green">最少必须4位</span></td></tr>
        <tr><td><strong>手机校验码规则：</strong></td><td>
		...
		<tr>
			...
			<td>
                <input type="checkbox" runat="server" id="RadioButtonList4" class="switchChk" />
		    </td>
		</tr>
		<tr>
...
<%--                <input type="checkbox" runat="server" id="Checkbox1" class="switchChk" />--%>
            </td>
        </tr>
		<tr>
	...
	<tbody id="Tabs2" style="display: none;width:100%;">
		<tr>
			<td style="width:30%;">会员找回密码的方式：</td>
			<td>
	...
	<tbody id="Tabs4" style="display: none; width:100%;">
		<tr>
			<td style="width:20%;"><strong>是否对同一IP注册进行时间间隔限制：</strong></td>
			<td>
    ...
    <tbody id="Tabs5" style="display: none; width:100%;">
        <tr>
            <td><strong>用户统计字段：</strong></td>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
 <style>
     .countfield_td .cols{padding:1px 0px!important;}
 </style>
