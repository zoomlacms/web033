<%@ page language="C#" autoeventwireup="true" inherits="test_ConPush, App_Web_g2bjvuv5" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <ItemTemplate>
                    <tr>
                        <td>
                            ...
                            <%#Eval("SourceAlias") %><span class="glyphicon glyphicon-arrow-right"></span><%#Eval("T_CateName") %></td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
        </table>
            ...
            <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="封面图">
                        <ItemTemplate>
                            <img src="<%#Eval("ImgUrl") %>" onerror="this.src='/Images/nopic.gif'" class="img_50" />
                        </ItemTemplate>
                    </asp:TemplateField>
