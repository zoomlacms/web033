<%@ page language="C#" autoeventwireup="true" inherits="Manage_APP_AddJsonP, App_Web_g2bjvuv5" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <tr>
            ...
            <td id="params_td">
                <div>
                    ...
                    <button type="button" onclick="AddParams()" class="btn btn-default"><span class="glyphicon glyphicon-plus"></span></button>
                </div>
            </td>
        </tr>
        <tr>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script>
        ...
        var paramtlp = "<div><input name='param' placeholder='参数名' class='form-control text_s' /> <select name='paramtype' class='form-control text_s'><option value='string'>string</option><option value='int'>int</option><option value='like'>like</option></select>"
                     + " <input name='defvalue' placeholder='默认值' class='form-control text_s' /> <button type='button' onclick='removeParams(this)' class='btn btn-default'><span class='glyphicon glyphicon-minus'></span></button></div>";
        ...
        function initParamData() {
            if ($("#Params_Hid").val()) {
                $(".glyphicon-minus").closest('div').remove();//清空添加的参数
