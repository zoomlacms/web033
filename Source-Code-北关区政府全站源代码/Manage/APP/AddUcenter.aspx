<%@ page language="C#" autoeventwireup="true" inherits="manage_APP_AddUcenter, App_Web_g2bjvuv5" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
     <table class="table table-striped table-bordered table-hover">
      ...
      <tr>
        ...
        <td><asp:TextBox ID="TxtWebSite" class="form-control text_300 isurl" runat="server" placeholder="www.zoomla.cn" />
