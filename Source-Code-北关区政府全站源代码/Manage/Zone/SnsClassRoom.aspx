<%@ page language="C#" autoeventwireup="true" inherits="manage_Zone_SnsClassRoom, App_Web_3kxtcvbw" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="相关操作">
                <ItemTemplate>
                    ...
                    <a href="AddClassRoom.aspx?menu=edit&id=<%#Eval("RoomID") %>" title="修改"><span class="glyphicon glyphicon-pencil"></span></a>
                    <asp:LinkButton ID="LinkButton2" CommandArgument='<%# Eval("RoomID") %>' CommandName="del" OnClientClick="return confirm('是否删除!')" ToolTip="删除" runat="server"><span class="glyphicon glyphicon-trash"></span></asp:LinkButton>
                    <a href="StudentList.aspx?cid=<%#Eval("RoomID") %>&stutype=1">学生列表</a>
                    <a href="StudentList.aspx?cid=<%#Eval("RoomID") %>&stutype=2">教师列表</a>
                    <a href="StudentList.aspx?cid=<%#Eval("RoomID") %>&stutype=3">家长列表</a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
