<%@ page language="C#" autoeventwireup="true" inherits="manage_Zone_AddSchool, App_Web_3kxtcvbw" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<script>
    ...
    function LoadIcon() {
        $("[name=glyphicon]").click(function () {
            $("#SchoolIcon_T").val($(this).prev().prev().attr("class"));
