<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="manage_Zone_AddClassRoom, App_Web_3kxtcvbw" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td class="tdleft"><strong>班级微标:</strong></td>
            <td>
