<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Page_PageRecyle, App_Web_wob3d5vk" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                 ...
                 <Columns>
                     <asp:TemplateField HeaderText="选择">
                        ...
                        <asp:TemplateField HeaderText="操作">
                            <ItemTemplate>
                                <asp:LinkButton ID="Btn_Rec" runat="server" CommandName="Rec" CommandArgument='<%# Eval("GeneralID") %>' ToolTip="还原"><span class="glyphicon glyphicon-repeat"></span></asp:LinkButton>
                                <asp:LinkButton ID="Btn_Del" runat="server" CommandName="Del" CommandArgument='<%# Eval("GeneralID") %>' OnClientClick="return confirm('你确定将该数据彻底删除吗？')" ><span class="glyphicon glyphicon-trash"></span></asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                    </Columns>
