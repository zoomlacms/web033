<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableeventvalidation="false" inherits="manage_Page_AuditUser, App_Web_wob3d5vk" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" viewStateEncryptionMode="Never" %>
    ...
    <ZL:TlpDown runat="server" />
        <div class="template">
            <div class="template_title"><h4>黄页样式:</h4></div>
                ...
                <div class="tempthumil"><a href="javascript:;" onclick="CheckTlp(this,'<%#Eval("PageNodeid") %>','<%#Eval("TemplateIndex") %>')" title="点击进入模板管理"><img onmouseover="this.style.border='1px solid #9ac7f0';" onerror="this.src='/UploadFiles/nopic.gif'" onmouseout="this.style.border='1px solid #eeeeee';" alt="点击进入模板管理" style="width: 100%;" src="<%#Eval("TemplateIndexPic") %>"></a></div>             
