<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.login, App_Web_hrjgsqod" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<a href="http://help.zoomla.cn/Database/" target="_blank" title="数据字典"><span class="glyphicon glyphicon-book"></span></a> &copy Zoomla!CMS Software Co., LTD All Rights Reserved
</li>
</ul>
</div>
</center>
