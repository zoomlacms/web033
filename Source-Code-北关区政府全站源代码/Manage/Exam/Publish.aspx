<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Exam_Publish, App_Web_yercog2q" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content runat="server" ContentPlaceHolderID="head">
    <title>版面管理</title>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <iframe id="child_ifr" src="/Manage/Exam/PublishDesign.html?id=44" style="float:left;width:430px;height:615px; border:none;" scrolling="no" ></iframe>
