<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Common/Common.master" inherits="Manage_Exam_SelKeyWords, App_Web_yercog2q" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="text-right">
        <div class="input-group text_300">
          ...
          <span class="input-group-btn">
              <asp:LinkButton ID="Search_Btn" CssClass="btn btn-default" OnClick="Search_Btn_Click" runat="server"><span class="glyphicon glyphicon-search"></span></asp:LinkButton>
          </span>
        </div>
    </div> 
