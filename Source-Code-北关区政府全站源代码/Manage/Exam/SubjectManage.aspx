<%@ page language="C#" autoeventwireup="true" inherits="Manage_Exam_SubjectManage, App_Web_yercog2q" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td><%#Eval("Flag") %></td>
                <td>
                    <asp:LinkButton ID="Edit" runat="server" CommandName="Edit" CommandArgument='<%#Eval("ID") %>'>修改</asp:LinkButton>
                    <asp:LinkButton ID="Del" runat="server" OnClientClick="return confirm('确认删除该学科吗？')" CommandName="Del" CommandArgument='<%#Eval("ID") %>'>删除</asp:LinkButton>
                </td>
            </tr>
        </ItemTemplate>
