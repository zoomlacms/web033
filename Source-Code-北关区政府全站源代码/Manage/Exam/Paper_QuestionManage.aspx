<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Paper_QuestionManage, App_Web_yercog2q" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script type="text/javascript">
        ...
        function SelQuestion() {
            diag.title = "选择题目";
            diag.url = "/User/Exam/SelQuestion.aspx?pid=<%=Pid %>&selids=" + $("#SelIDS_IDS").val();
            diag.maxbtn = false;
            diag.ShowModal();
        }
        function CLoseDIag() {
