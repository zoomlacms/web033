<%@ page language="C#" autoeventwireup="true" inherits="Manage_Exam_QuestList, App_Web_yercog2q" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <ZL:ExGridView ID="EGV" runat="server" DataKeyNames="Tagkey" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" EnableTheming="False" IsHoldState="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="试题标题">
                        <ItemTemplate>
                            <a href="AddEngLishQuestion.aspx?p_id=<%#Eval("p_id") %>"><%#Eval("p_title") %></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="相关操作" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                        <ItemTemplate>
                            <a href="QuestShow.aspx?id=<%#Eval("p_id") %>" title="预览"><span class="fa fa-eye"></span></a>
                            <a href="AddEngLishQuestion.aspx?p_id=<%#Eval("p_id") %>" title="修改"><span class="glyphicon glyphicon-pencil"></span></a>
                            <asp:LinkButton runat="server" CommandName="del2" OnClientClick="return confirm('是否确定删除!')" CommandArgument='<%#Eval("p_id") %>' ToolTip="删除"><span class="glyphicon glyphicon-trash"></span></asp:LinkButton> 
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </ZL:ExGridView>
