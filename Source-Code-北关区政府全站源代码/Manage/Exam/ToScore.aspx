<%@ page language="C#" autoeventwireup="true" inherits="manage_Exam_ToScore, App_Web_yercog2q" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="td_l">
                <ItemTemplate>
                    <a target="_blank" href="ExamDetail.aspx?ID=<%#Eval("PaperID")+"&Action=View&FlowID="+Eval("FlowID") %>">批阅试卷</a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
