<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="manage_AddOn_Projects, App_Web_kr3zjxr3" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content ContentPlaceHolderID="head" runat="Server"><title><%=lang.LF("查看项目")%></title></asp:Content>
<asp:Content ContentPlaceHolderID="Content" runat="Server">
    <style type="text/css">
        .inputgp {border-right-color: currentColor; border-right-width: medium; border-right-style: none;}
    </style>
    <div class="top_opbar">
    ...
    <ul class="nav nav-tabs">
        ...
        <li id="tab1"><a onclick="ShowTabss(1,0)"><%=lang.LF("未审核")%></a></li>
        <li id="tab2"><a onclick="ShowTabss(2,0)"><%=lang.LF("已审核")%></a></li>
        <li id="tab3"><a onclick="ShowTabss(3,0)"><%=lang.LF("未启动")%></a></li>
        <li id="tab4"><a onclick="ShowTabss(4,0)"><%=lang.LF("已启动")%></a></li>
        <li id="tab5"><a onclick="ShowTabss(5,0)"><%=lang.LF("已完成")%></a></li>
        <li id="tab6"><a onclick="ShowTabss(6,0)"><%=lang.LF("存档")%></a></li>
    </ul>
