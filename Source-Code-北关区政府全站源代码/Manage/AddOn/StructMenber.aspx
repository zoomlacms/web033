<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="manage_AddOn_StructMenber, App_Web_zjbkmfd2" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script type="text/javascript">
        ...
        function showdiv(div_id, n) {
            diag.title = "选择成员";
            diag.url = "/Mis/OA/Mail/SelGroup.aspx?Type=AllInfo&Fid=<%:UserIDS %>";
            diag.maxbtn = false;
            diag.ShowModal();
        }
