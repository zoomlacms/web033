<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="manage_AddOn_ProjectsModelField, App_Web_zjbkmfd2" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
	...
	<asp:Repeater ID="RepModelField" runat="server" OnItemCommand="Repeater1_ItemCommand">
		<ItemTemplate>
			<tr>
				...
				<td><a href="../Content/AddModelField.aspx?FieldID=<%# Eval("FieldID") %>&ModelType=10&ModelID=-1">修改</a> |
