<%@ page language="C#" autoeventwireup="true" inherits="manage_AddOn_ProjectsDetail_, App_Web_kr3zjxr3" validaterequest="false" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>

<asp:Content runat="server" ContentPlaceHolderID="head"><title><%=lang.LF("查看项目")%></title></asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div>
     <ul class="nav nav-tabs">
        <li class="active"><a id="TabTitle0" onclick="show1(0)">项目进度</a></li>
        <li><a id="TabTitle1" onclick="show1(1)">项目详情</a></li>
        <li><a id="TabTitle2" onclick="show1(2)">交流互动</a></li>
    </ul>
    </div>
    <div id="Tabs0">
