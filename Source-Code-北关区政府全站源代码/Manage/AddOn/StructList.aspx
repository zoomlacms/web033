<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="manage_AddOn_StructList, App_Web_zjbkmfd2" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" EnableTheming="False" IsHoldState="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="StructMenber.aspx?id=<%#Eval("ID") %>" title="成员管理"><i class="fa fa-users"></i></a>
                             <asp:LinkButton CommandName="Edit" CommandArgument='<%#Eval("ID") %>' ToolTip="修改" runat="server">
                                <i class="glyphicon glyphicon-pencil"></i></asp:LinkButton>
                            <a href='javascript:;' onclick='delstruct(<%#Eval("ID") %>)'><i class='glyphicon glyphicon-trash'></i></a>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    <script type="text/javascript">
        ...
        var trtlp = "<tr data-pid='@pid' data-index='@index'><td><input name='idchk' type='checkbox' value='@id'></td><td>@id</td><td>@treeindex<img src='/Images/TreeLineImages/t.gif' border='0' /><a href='AddStruct.aspx?ID=@id'>@icon @title</a></td>"
                        ...
                        + "<td><a href='StructMenber.aspx?id=@id' title='成员管理'><i class='fa fa-users'></i></a> <a href='AddStruct.aspx?ID=@id&type="+type+"'><i class='glyphicon glyphicon-pencil'></i></a> "
                        + "<a href='javascript:;' onclick='delstruct(@id)'><i class='glyphicon glyphicon-trash'></i></a> <a href='AddStruct.aspx?pid=@id&type="+type+"'><i class='fa fa-plus'></i>添加子级</a></td></tr>";
        $().ready(function () {
