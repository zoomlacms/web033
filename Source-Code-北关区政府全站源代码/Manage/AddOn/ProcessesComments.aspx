<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Manage/I/Default.master" inherits="manage_AddOn_ProcessesComments, App_Web_zjbkmfd2" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table>
	<tr>
		<td>
			...
			<asp:Button ID="btnDeleteAll" runat="server" style="width:110px;"  OnClientClick="return confirm('你确定删除吗？')" Text="批量删除" OnClick="btnDeleteAll_Click" class="btn btn-primary" />
		</td>
	</tr>
</table>
<table class="table table-bordered table-hover">
	...
	<div style=" text-align:center; width:792px"><asp:Button ID="BtnCommit" 
		 ...
		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<asp:Button ID="BtnBack" runat="server" Text="返回" class="btn btn-primary" 
