<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_AuthorManage, App_Web_kr3zjxr3" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="panel panel-default" style="padding:0px;">
        ...
        <Columns>
            ...
            <ItemTemplate>
                ...
                <a href="javascript:if(confirm('你确定要删除吗?')) window.location.href='AuthorManage.aspx?AUId=<%# Eval("ID")%>';" class="option_style"><i class="fa fa-trash-o" title="删除"></i></a> 
            </ItemTemplate>
                <ItemStyle CssClass="tdbg" />
            </asp:TemplateField>
        </Columns>
