<%@ page language="C#" autoeventwireup="true" inherits="manage_File_FtpConfig, App_Web_kjph4ddp" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div>
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txt_fs" runat="server" CssClass="form-control text_300" Text="u.zoomla.cn"></asp:TextBox>&nbsp;&nbsp;可以是别名，如u.zoomla.cn
                </td>
            </tr>
            <tr>
                <td align="left">访问路径：
                ...
                <td>
                    <asp:TextBox ID="txt_url" runat="server" CssClass="form-control text_300" Text="u.zoomla.cn"></asp:TextBox>
