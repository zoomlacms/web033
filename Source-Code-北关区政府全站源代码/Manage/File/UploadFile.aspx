<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.AddOn.UploadFile, App_Web_kjph4ddp" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <asp:Repeater ID="RptFiles" runat="server" OnItemCommand="RptFiles_ItemCommand">
            ...
            <ItemTemplate>
                <tr>
                    <td style="text-align:left;width:20%;">
                        <%# System.Convert.ToInt32(Eval("type")) == 1 ? "<i class='fa fa-folder'></i>" : GetShowExtension(Eval("content_type").ToString())%>
        ...
        <asp:Button ID="Backup" runat="server" Text="备份当前目录文件" class="btn btn-primary" OnClick="Backup_Click1" OnClientClick="if(!this.disabled) return confirm('是否创建备份？(提示：备份同名文件会覆盖！)');"/> <a href="javascript:;" id="upfile_btn" class="btn btn-primary">上传文件</a>
        <!-- 提示是否 -->
</asp:Content>
