<%@ page language="C#" autoeventwireup="true" inherits="Manage_Boss_UserBonus, App_Web_wkjqoyuj" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content runat="server" ContentPlaceHolderID="head"><title>会员分红</title></asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="top_opbar">
        <div class="input-group" style="width: 640px; margin-left: 5px; float: left;">
            ...
            <span class="input-group-btn">
                <asp:LinkButton runat="server" ID="Skey_Btn" OnClick="Skey_Btn_Click" CssClass="btn btn-default"><span class="glyphicon glyphicon-search"></span></asp:LinkButton>
            </span>
        </div>
