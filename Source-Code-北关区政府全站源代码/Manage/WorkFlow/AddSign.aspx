<%@ page language="C#" autoeventwireup="true" inherits="Manage_WorkFlow_AddSign, App_Web_v1vspsat" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <td>
                    <div class="input-group" style="width: 300px;">
                        ...
                        <span class="input-group-btn">
                            <input type="button" id="selUserBtn" value="选择用户" class="btn btn-primary" />
                        </span>
                    </div>
                </td>
            </tr>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script>
        $(function () {
            ZL_UserList.GetSelector('selUserBtn', {
                isshow:false,
                onselect: function (userlist) {
                    $("#bindUserT").val(userlist[0].UserName);
                }
            });
        });
        var uid = "";
