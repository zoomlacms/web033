<%@ page language="C#" autoeventwireup="true" inherits="Manage_WorkFlow_SelModelFieds, App_Web_v1vspsat" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="list-group">
          <ZL:Repeater ID="RPT" runat="server">
            ...
            <ZL:Repeater ID="Fied_RPT" runat="server">
              <ItemTemplate>
                  <a href="javascript:;"  class="list-group-item selfield"><%#Eval("FieldName")%>(<%#Eval("FieldAlias")%>)<input name="fields" style="display:none;" value="<%#Eval("FieldName")%>" type="checkbox" /><span class="badge" style="display:none;"><span class="glyphicon glyphicon-ok"></span></span></a>
              </ItemTemplate>
          </ZL:Repeater>
        </div>
