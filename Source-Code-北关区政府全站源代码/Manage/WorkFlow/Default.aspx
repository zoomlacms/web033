<%@ page language="C#" autoeventwireup="true" inherits="Manage_WorkFlow_Default, App_Web_v1vspsat" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    ...
                    <a href="javascript:;" onclick="ShowImgDiag(<%#Eval("ID") %>)">查看流程图</a>
