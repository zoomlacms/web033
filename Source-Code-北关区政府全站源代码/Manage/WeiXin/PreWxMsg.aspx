<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="Manage_WeiXin_PreWxMsg, App_Web_bcjzsuq4" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div id="newinfo" style="display:none;">
        <div class="container-fluid newslist singleMsg">
            ...
            <div class="option">
                <div>阅读全文<span class="pull-right"><span class="glyphicon glyphicon-chevron-right gray_9"></span></span></div>
            </div> 
        </div>
    </div>
