<%@ page language="C#" autoeventwireup="true" inherits="Manage_WeiXin_WxMaterial, App_Web_bcjzsuq4" validaterequest="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                      ...
                      <asp:Repeater ID="WxApp_RPT" runat="server">
                          <ItemTemplate>
                                <li class="list-group-item wx_option" data-appid="<%#Eval("ID") %>">
                                    <a href="WxMaterial.aspx?type=news&appid=<%#Eval("ID") %>"><%#Eval("Alias") %> <span class="badge pull-right"><span class="glyphicon glyphicon-ok"></span></span></a> 
                                </li>
                          </ItemTemplate>
                      </asp:Repeater>
                  </ul>
                ...
                <ItemTemplate>
                    <div class="col-md-2 listdata margin_t10">
                        <div class="container-fluid infolist">
                            ...
                            <div class="option"><a href="javascript:;" onclick="DelMater(this,'<%#Eval("media_id") %>')"><span class="glyphicon glyphicon-trash"></span></a></div>
                        </div>
                    </div>
                </ItemTemplate>
                ...
                <ItemTemplate>
                    <div class="col-md-2 listdata margin_t10">
                        <div class="container-fluid newslist" data-appid="<%#Eval("media_id") %>">
                            ...
                            <div class="option">
                                <div><a href="MsgsSend.aspx?media_id=<%#Eval("media_id") %>&appid=<%=AppId %>" title="修改素材"><span class="glyphicon glyphicon-pencil"></span></a></div>
                                <div><a href="javascript:;" onclick="DelMater(this,'<%#Eval("media_id") %>')" title="删除素材"><span class="glyphicon glyphicon-trash"></span></a></div>
                            </div> 
                        </div>
                    </div>
                </ItemTemplate>
