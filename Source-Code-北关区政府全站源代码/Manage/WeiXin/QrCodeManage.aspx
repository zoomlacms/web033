<%@ page language="C#" autoeventwireup="true" inherits="manage_WeiXin_QrCodeManage, App_Web_bcjzsuq4" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<ZL:ExRepeater ID="RPT" runat="server" PagePre="<tr><td colspan='6' class='text-center'><input type='checkbox' id='CheckAll' />" PageEnd="</td></tr>" OnItemCommand="Repeater1_ItemCommand" >
<ItemTemplate>
