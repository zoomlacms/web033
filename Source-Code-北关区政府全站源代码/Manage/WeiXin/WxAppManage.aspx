<%@ page language="C#" autoeventwireup="true" inherits="Manage_WeiXin_WxAppManage, App_Web_bcjzsuq4" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<ZL:ExGridView ID="Egv" runat="server" AutoGenerateColumns="False" PageSize="10" OnPageIndexChanging="Egv_PageIndexChanging" IsHoldState="false" AllowPaging="True" AllowSorting="True" CssClass="table table-striped table-bordered table-hover" 
    EnableTheming="False" EnableModelValidation="True" OnRowCommand="Egv_RowCommand" EmptyDataText="暂无公众号信息!">
    <Columns>
        <asp:TemplateField>
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="管理微信">
            <ItemTemplate>
                <div class="option_area dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu"> 
                        ...
                        <li><a class="option_style" href="EditWxMenu.aspx?appid=<%#Eval("ID") %>"><i class="glyphicon glyphicon-book"></i>菜单配置</a></li>   
        ...
        <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="opt_div">
            <ItemTemplate> 
                <a class="option_style" href="WxConfig.aspx?id=<%#Eval("ID") %>"><span class="glyphicon glyphicon-pencil" title="编辑"></span></a>
                <asp:LinkButton runat="server" OnClientClick="return confirm('是否删除该项')" CommandName="Del" CommandArgument='<%#Eval("ID") %>' CssClass="option_style"><span class="glyphicon glyphicon-trash" title="删除"></span> 删除</asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</ZL:ExGridView>
