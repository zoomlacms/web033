<%@ page language="C#" autoeventwireup="true" inherits="test_MsgsSend, App_Web_bcjzsuq4" validaterequest="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div id="Message_Div" runat="server" visible="false" class="alert alert-danger" role="alert"><span class="glyphicon glyphicon-info-sign"></span> 您今天已群发过一次了!</div>
                    ...
                    <div class="row">
                        <div class="appmsg multi col-lg-3 col-md-3 col-xs-3 col-sm-3">
                            <div class="msgthumb msgitemf" data-id="default">
                                <img src="/Images/nopic.gif" class="headimg" />
                                <div class="msgthumb_foot">
                                    <div class="title_div" style="float:left;">标题</div>
                                    <div style="float:right;"><a href="javascript:;" title="编辑" class="edit_a"><i class="glyphicon glyphicon-pencil"></i></a></div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-9 col-md-9 col-xs-9 col-sm-9">
                            <table class="table table-bordered table-striped">
                                <tr><td class="wxtextl"><i class="glyphicon glyphicon-text-width"></i>标题</td><td><asp:TextBox runat="server" ID="title_t" CssClass="form-control text_300" onkeyup="UpdateTitle(this);"/></td></tr>
                                <tr><td class="wxtextl"><i class="glyphicon glyphicon-picture"></i>图片</td><td>
                                ...
                                <tr>
                                    <td class="wxtextl"><i class="glyphicon glyphicon-facetime-video"></i>视频</td>
                                    <td>
                                ...
                                <tr><td class="wxtextl"><i class="glyphicon glyphicon-align-justify"></i>正文</td>
                                    <td>
                                    <asp:TextBox runat="server" ID="content_t" style="width:800px; height:300px;" TextMode="MultiLine" />
                                    <%=Call.GetUEditor("content_t",3) %>
                                    </td></tr>
                                <tr><td class="wxtextl"><i class="glyphicon glyphicon-link"></i>链接</td><td><asp:TextBox runat="server" ID="url_t" CssClass="form-control text_300" /><span class="wtinfo">(选填)</span></td></tr>
                            </table>
                        </div>
                    </div>
                </div>
                      ...
                      <asp:Repeater ID="WxApp_RPT" runat="server">
                          <ItemTemplate>
                                <li class="list-group-item wx_option">
                                    <%#Eval("Alias") %> <span class="badge"><span class="glyphicon glyphicon-ok"></span></span><input type="checkbox" name="appids" value="<%#Eval("ID") %>" style="display:none" />
                                </li>
                          </ItemTemplate>
                      </asp:Repeater>
                  </ul>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script>
        ...
        var itemTlp = '<div class="msgitem msgitemf" data-id="@id"><div class="itemleft"><div class="title_div">标题</div>'
                    + '<div class="msgopt"><a href="javascript:;" title="编辑" class="edit_a"><i class="glyphicon glyphicon-pencil"></i></a><a href="javascript:;" title="删除" class="del_a"><i class="glyphicon glyphicon-trash"></i></a></div>'
                    + '</div><div class="itemright"><img class="itemimg" src="/Images/nopic.gif" /></div></div>';
        var dataArr = [];
        var curid = "default";
        $(function () {
        ...
        function GetByID(id) {
            return ArrCommon.GetModelByID(dataArr, id);
        }
        function DelByID(id) {
            ArrCommon.DelByID(dataArr, id);
        }
        function GetCur() {
        ...
        function SaveToData() {
            ...
            data.description = $("#Video_T").val()+$("#content_t").val();
