<%@ page language="C#" autoeventwireup="true" inherits="Manage_WeiXin_AutoReply, App_Web_bcjzsuq4" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="alert alert-info" role="alert">
     <span class="glyphicon glyphicon-info-sign"></span> 图片与语音需在素材管理中添加
    </div>
