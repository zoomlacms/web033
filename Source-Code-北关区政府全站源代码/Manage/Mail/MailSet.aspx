<%@ page language="C#" autoeventwireup="true" inherits="manage_Mail_MailSet, App_Web_n420ud3m" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td class="td_l tdleft"><strong>别&nbsp;&nbsp;&nbsp;&nbsp;名：</strong></td>
            <td>
        ...
        <tr>
            <td class="tdleft"><strong>邮&nbsp;&nbsp;&nbsp;&nbsp;箱：</strong></td>
            <td>
        ...
        <tr>
            <td class="tdleft"><strong>选择分类：</strong></td>
            <td>
