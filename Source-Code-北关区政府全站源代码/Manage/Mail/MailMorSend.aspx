<%@ page language="C#" autoeventwireup="true" inherits="manage_Mail_MailMorSend, App_Web_cvd0h5se" enableviewstatemac="false" validaterequest="false" masterpagefile="~/Manage/I/Default.master" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="MailTemp" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="GetTempCon" Width="160px">
                    <asp:ListItem></asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td class="tdleft"><strong>选择联系人组：</strong></td>
            <td>
        ...
        <tr>
            <td class="tdleft"><strong>主 题：</strong></td>
            <td style="text-align: left">
        ...
        <tr>
            <td class="tdleft"><strong>内 容：</strong></td>
            <td style="text-align: left">
        ...
        <tr>
            <td class="tdleft"><strong>发件人别名：</strong></td>
            <td style="text-align: left">
