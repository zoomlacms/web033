<%@ page language="C#" autoeventwireup="true" inherits="manage_iServer_AddQuestionRecord, App_Web_ixgzjjdq" masterpagefile="~/Manage/I/Default.master" clientidmode="Static" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>只能上传<span id="filetype" runat="server"></span>类型的附件,单个附件小于 500KB
                <br />
                附件1:
                <asp:FileUpload ID="FileUpload1" CssClass="form-control text_md" runat="server" onkeydown="event.returnValue=false;" onpaste="return false" /><br />
                附件2:
                <asp:FileUpload ID="FileUpload2" CssClass="form-control text_md" runat="server" onkeydown="event.returnValue=false;"
                    onpaste="return false" /><br />
                附件3:
                <asp:FileUpload ID="FileUpload3"  CssClass="form-control text_md" runat="server" onkeydown="event.returnValue=false;" onpaste="return false" /><br />
