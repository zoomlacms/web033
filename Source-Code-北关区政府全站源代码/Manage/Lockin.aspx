<%@ page language="C#" autoeventwireup="true" inherits="manage_Lockin, App_Web_hrjgsqod" masterpagefile="~/Common/Common.master" enableviewstatemac="false" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div style="padding-top: 200px;">
	    <div id="lock">
		    <div class="loFont">
                <div class="pass_div">
			    <span class="glyphicon glyphicon-alert" style="font-size:16px;"></span> 当前界面被管理员锁定<br />
