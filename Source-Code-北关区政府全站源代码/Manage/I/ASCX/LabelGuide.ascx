<%@ control language="C#" autoeventwireup="true" inherits="Manage_I_ASCX_LabelGuide, App_Web_3tj1t2km" %>
...
<div class="tvNavDiv" style="height:auto;">
    <div class="left_ul">
        <ul>
            ...
            <li><a href="javascript:;" onclick="ShowMain('','{$path}Content/Addon/MNBakList.aspx')">元数据备份</a></li>
        </ul>
