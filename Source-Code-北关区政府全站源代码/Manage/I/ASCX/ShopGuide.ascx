<%@ control language="C#" autoeventwireup="true" inherits="Manage_I_ASCX_ShopGuide, App_Web_w2evetuw" %>
<div class="tvNavDiv">
    <div class="input-group">
        ...
        <span class="input-group-btn">
            <button class="btn btn-default" type="button" onclick="ASCX.Search('<%:CustomerPageAction.customPath2+"Shop/ProductManage.aspx?keyWord=" %>','keyWord');"><span class="glyphicon glyphicon-search"></span></button>
        </span>
    </div>
    <div class="left_ul">
        <ul>
