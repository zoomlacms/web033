<%@ control language="C#" autoeventwireup="true" inherits="Manage_I_ASCX_WxTree, App_Web_3tj1t2km" %>
<div class="tvNavDiv">
<div class="left_ul">
<ul class="m_left_ulin" id="menu7_9">
    <li class="bg-primary"><span class="glyphicon glyphicon-globe"></span>微信管理</li>
    <li>
