<%@ control language="C#" autoeventwireup="true" inherits="Manage_I_ASCX_PaperGuide, App_Web_w2evetuw" %>
<div id="nodeNav" style="padding:0 0 0 0;">
         <div class="input-group">
            <input type="text" id="keyWord" class="form-control ascx_key" onkeydown="return ASCX.OnEnterSearch('<%:CustomerPageAction.customPath2+"Exam/Papers_System_Manage.aspx?keyWord=" %>',this);" placeholder="试卷标题或ID" />
