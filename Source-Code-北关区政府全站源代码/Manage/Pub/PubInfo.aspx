<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Pub_PubInfo, App_Web_nsadxgpt" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <table id="table" class="table table-bordered">
        ...
        <tr runat="server" id="PubNames">
            ...
            <td>
                <asp:TextBox ID="PubName" runat="server" CssClass="form-control text_300" onchange="checkmodelname(this)" onkeyup="Getpy('PubName','PubTableName','PubLoadstr','PubInputLoadStr')"></asp:TextBox>
                &nbsp;<font color="red">*</font>
        ...
        <tr runat="server" id="Tr1">
            ...
            <td>&nbsp;<span >ZL_Pub_</span><asp:TextBox ID="PubTableName" onchange="checkmodelname(this)" runat="server" Width="101px" CssClass="form-control" />
                &nbsp;<asp:DropDownList ID="ModelList" Width="180" onchange="setmodelname(this)" runat="server" CssClass="form-control"></asp:DropDownList>
                &nbsp;<font color="red">*</font>
