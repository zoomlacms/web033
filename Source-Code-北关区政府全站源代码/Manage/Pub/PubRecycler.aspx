<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Pub_PubRecycler, App_Web_nsadxgpt" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ContentPlaceHolderID="Content" runat="Server">
    <div class="panel panel-default" style="padding:0px;">
        ...
        OnPageIndexChanging="Egv_PageIndexChanging" IsHoldState="false" AllowPaging="True" AllowSorting="True" CssClass="table table-striped table-bordered table-hover"
         EnableTheming="False" EnableModelValidation="True" EmptyDataText="暂无相关信息！">
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                ...
                <ItemTemplate>
                    ...
                    <a href="pubinfo.aspx?menu=Truedelete&id=<%#Eval("Pubid")%>" onclick="return confirm('确实要彻底删除吗？');" class="option_style"><i class="fa fa-trash" title="彻底删除"></i></a>
                    <a href="pubinfo.aspx?menu=revert&id=<%#Eval("Pubid")%>" class="option_style"><i class="fa fa-recycle" title="还原"></i>还原</a>
                    <a href="Pubsinfo.aspx?Pubid=<%#Eval("Pubid") %>&type=0" class="option_style"><i class="fa fa-magic" title="管理"></i>管理信息</a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
