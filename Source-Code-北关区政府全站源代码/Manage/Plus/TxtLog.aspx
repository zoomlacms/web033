<%@ page language="C#" autoeventwireup="true" inherits="Manage_Plus_TxtLog, App_Web_cp4azpc5" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    ...
                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Name") %>' CommandName="down" CssClass="option_style"><i class="fa fa-download" title="下载"></i></asp:LinkButton>
                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Name") %>' CommandName="del2" OnClientClick="return confirm('确定要删除吗');" CssClass="option_style"><i class="fa fa-trash-o" title="删除"></i></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
