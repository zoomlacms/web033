<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.SurveyItem, App_Web_cp4azpc5" validaterequest="false" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script>
        ...
        var sel_textTlp = '<div class="sel_op_item"><input type="text" name="sel_text" class="form-control text_300 sel_text" value="@value" />'
                    + '<a href="javascript:;" class="sel_add btn btn-default"><span class="glyphicon glyphicon-plus"></span></a>'
                    + '<a href="javascript:;" class="sel_del btn btn-default"><span class="glyphicon glyphicon-minus"></span></a></div>';
