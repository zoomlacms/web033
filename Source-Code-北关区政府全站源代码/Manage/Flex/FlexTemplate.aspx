<%@ page language="C#" autoeventwireup="true" inherits="manage_Flex_FlexTemplate, App_Web_zr45hj3g" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    ...
                    <asp:LinkButton ID="LinkButton1" CommandArgument='<%#Eval("Mu_ID") %>' CommandName="del1" runat="server" CssClass="option_style"><i class="fa fa-trash-o" title="删除"></i></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
