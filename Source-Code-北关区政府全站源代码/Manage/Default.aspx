<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Default, App_Web_hrjgsqod" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
<html>
<head>
...
<ul class="menu3">
	...
	<li class="menu3_8"><a onclick="showleft('menu3_8','User/Promo/PromoList.aspx')">推广中心</a></li>
...
<ul class="menu5">
    <li class="menu5_1"><a onclick="ShowMain('QuestGuide.ascx?url=Exam/Papers_System_Manage.aspx','Exam/Papers_System_Manage.aspx')"><%:lang.LF("试卷管理") %></a></li>
...
<div id="left_ul_div">
	...
	<div id="menu2" class="m_left_ul">
		...
		<ul class="list-unstyled m_left_ulin" id="menu2_9">
            ...
            <li><p class="bg-info laybtn"><i class="fa fa-arrow-circle-down"></i>论坛留言</p>
            <ul class="list-unstyled">
            ...
            <li><p class="bg-info laybtn"><i class="fa fa-arrow-circle-down"></i>问答管理</p>
            <ul class="list-unstyled">
			...
			<li><p class="bg-info laybtn"><i class="fa fa-arrow-circle-down"></i>百科管理</p>
            <ul class="list-unstyled">           
	...
	<%--	<li id="menu3_7_2"><a href="javascript:;" data-url="Shop/FreePost.aspx"><%:lang.LF("免邮设置") %></a></li>--%>
		...
		<ul id="menu3_8" class="m_left_ulin">
			<li class="menu_tit"><span class="glyphicon glyphicon-globe"></span>推广中心</li>
            <li id="menu3_8_1"><a href="javascript:;" data-url="User/Promo/PromoChart.aspx">图表分析</a></li>
            <li id="menu3_8_2"><a href="javascript:;" data-url="User/Promo/PromoList.aspx">排行榜</a></li>
            <li id="menu3_8_3"><a href="javascript:;" data-url="User/Promo/PromoUserList.aspx">用户流水</a></li>
			<li id="menu3_8_4"><a href="javascript:;" data-url="Shop/profile/StatisticsBriefing.aspx">统计简报</a></li>
            <li id="menu3_8_5"><a href="javascript:;" data-url="User/UnitMain.aspx">管理奖金</a></li>
			<!--<li id="menu3_12_2"><a href="javascript:;" data-url="Shop/profile/config.aspx">推广设置</a></li>-->
            <li id="menu3_8_6"><a href="javascript:;" data-url="User/DepositManage.aspx">用户提现</a></li>
 <%--           <li id="menu3_8_7"><a href="javascript:;" data-url="Boss/UserBonus.aspx">会员分红</a></li>
            ...
            <li id="menu3_8_9"><a href="javascript:;" data-url="Shop/PVManager.aspx">订单提成</a></li>
...
<%--	<ul id="menu3_12" class="m_left_ulin">
	...
	<%--	<li id="menu5_2_2"><a href="javascript:;" data-url="Exam/ScoreStatics.aspx"><%:lang.LF("成绩统计") %></a> </li>--%>
		...
		<ul class="m_left_ulin" id="menu5_7">
            ...
            <li id="menu5_7_3"><a href="javascript:;" data-url="Exam/Setting.aspx">配置中心</a></li>
     ...
     <%--   <li id="menu5_7_3"><a href="javascript:;" data-url="Exam/QuestGrade.aspx?cate=5">难度管理</a></li>--%>
			...
			<li id="menu5_7_5"><a href="javascript:;" data-url="Exam/VersionList.aspx">教材版本</a></li>
	...
	<div id="menu7" class="m_left_ul">
        ...
        <ul class="m_left_ulin" id="menu7_9">
            ...
            <li><p class="bg-info laybtn"><i class="fa fa-arrow-circle-down"></i>微信应用</p>
                <ul class="list-unstyled">
            ...
            <li><p class="bg-info laybtn"><i class="fa fa-arrow-circle-down"></i>微信支付</p>
            <ul class="list-unstyled">
	...
	<div id="menu8" class="m_left_ul">
		...
		<ul class="m_left_ulin" id="menu8_3">
			...
			<li id="menu8_3_3"><a href="javascript:;" data-url="Content/UnionNode.aspx">合并迁移</a></li>
    ...
    <div id="menu10" class="m_left_ul">
		<ul class="m_left_ulin open" id="menu10_1">
          ...
          <%--  <li id="menu10_1_2"><a href="javascript:;" data-url="/APP/Client/Default.aspx?u=Default.aspx&t=网站APP">网站APP</a></li>
            ...
            <li id="menu10_1_2"><a href="javascript:;" data-url="/APP/Default.aspx">网站APP</a></li>
            <li id="menu10_1_6"><a href="javascript:;" data-url="/APP/Default.aspx?APKMode=1">云打包APP</a></li>
            <li id="menu10_1_1"><a href="javascript:;" data-url="WeiXin/home.aspx"><%:lang.LF("应用列表") %></a></li>
 <%--       <li id="menu10_1_3"><a href="http://wei.zoomla.cn/" target="_blank"><%:lang.LF("移动模拟器") %></a></li>--%>
            <li id="menu10_1_4"><a href="javascript:;" data-url="/APP/CL.aspx">APP颁发</a></li>
            <li id="menu10_1_8"><a href="javascript:;" data-url="App/AppTlpOnline.aspx">我的模板</a></li>
            <li id="menu10_1_9"><a href="javascript:;" data-url="/APP/APPList.aspx">我的APP</a></li>
        </ul>
        <ul class="m_left_ulin" id="menu10_2"> 
		    <li class="bg-primary"><span class="glyphicon glyphicon-globe"></span>微信应用</li>		
            <li><p class="bg-info laybtn"><i class="fa fa-arrow-circle-down"></i>公众号码</p>
            <ul class="list-unstyled">
