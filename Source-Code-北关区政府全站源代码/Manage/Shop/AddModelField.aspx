<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Shop.AddModelField, App_Web_vzmvl1l4" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        <tr>
            ...
            <td>
            <asp:TextBox ID="Alias" runat="server" MaxLength="20" /><span class="rd_red">*</span>
                <span class="tips modeldesc"> 如：文章标题</span></td>
        </tr>
        <tr>
            <td class="tdbgleft">字段名称：</td>
            <td>
                <asp:TextBox ID="Name" MaxLength="50" runat="server" /><span class="rd_red">*</span>
                <span class="tips modeldesc">字段名由字母、数字、下划线组成，不接受空格</span></td>
        </tr>
        <tr>
            <td class="tdbgleft">字段提示：</td>
            <td>
                <asp:TextBox ID="Tips" MaxLength="50" runat="server" />
                <span class="tips modeldesc">显示在字段别名下方作为重要提示的文字</span></td>
        </tr>
        <tr>
            <td class="tdbgleft">字段描述：</td>
            <td><asp:TextBox ID="Description" runat="server" TextMode="MultiLine" Height="77px" Width="350px" /></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <asp:RadioButtonList ID="IsShow" runat="server" RepeatDirection="Horizontal">
                ...
                <span class="modeldesc">选择“否”可作为相关隐藏识别符而不能输出在前台(仅能后台录入)。</span></td>
        </tr>
        ...
        <tbody id="DivTextType">
            ...
            <tr>
                ...
                <td><asp:TextBox ID="TextType_DefaultValue"  runat="server" Columns="10" /></td>
            </tr>
        </tbody>
        <!--  多行文本(不支持Html)    -->
        ...
        <tbody id="DivOptionType" style="display:none">
            <tr>
                ...
                <td><input id="Button3" type="button" value="从数据字典中选择选项" class="btn btn-primary"  style="width:150px;" onclick="SelectDictionary('RadioType_Content')" /><input 
                    ...
                    <asp:TextBox ID="RadioType_Content"  runat="server" 
                        TextMode="MultiLine" Columns="40" Rows="6" Height="79px" Width="351px" /> <span style="color: red">*</span></td>
            </tr>
            <tr>
                <td class="tdbgleft">默认值：</td>
                <td><asp:TextBox ID="RadioType_Default"  runat="server" /> <span style="color: #808000">注：没有数据录入的默认值，与前台显示无关.</span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input id="Button4" type="button" value="从数据字典中选择选项" class="btn btn-primary"  style="width:150px;"  onclick="SelectDictionary('ListBoxType_Content')" /><input 
                    ...
                    <asp:TextBox ID="ListBoxType_Content"  runat="server" 
                        TextMode="MultiLine" Columns="40" Rows="6" Height="75px" Width="350px" /> <span style="color: red">*</span></td>
            </tr>
            <tr>
                <td class="tdbgleft">显示选项：</td>
            ...
            <tr>
                ...
                <td>
                    <table cellspacing="0" cellpadding="0" width="100%" border="0" align="center">
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="DateSearchRang"  runat="server" 
                                    TextMode="MultiLine" Columns="40" Rows="6" Height="76px" Width="244px" /><br />
        ...
        <tbody id="DivPicType" style="display:none">
            ...
            <tr>
                <td class="tdbgleft">
                    允许上传的图片类型：</td>
                <td>
                    <asp:TextBox ID="TxtPicExt"  runat="server" Columns="30" /><span style="color: red">*</span>
        ...
        <tbody id="DivMultiPicType" style="display:none">
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="TxtThumb"  runat="server" Columns="20" /><span style="color:Red;display:none;">保存缩略图地址字段名不能与主字段名重复！</span></td>
            </tr>
            <tr>
                <td class="tdbgleft">图片是否加水印：</td>
                <td>
            ...
            <tr>
                <td class="tdbgleft">
                    允许上传的图片类型：</td>
                <td>
                    <asp:TextBox ID="TextImageType"  runat="server" Columns="30" /> <span style="color: red">*</span>
                <span style="color: Blue">注：允许多个类型请用“|”号分割，如：jpg|gif|bmp等等</span></td>
            </tr>
        </tbody>            
         <!--  文件类型    -->
    <tbody id="DivSmallFileType" style="display: none">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TxtUploadFileTypes"  runat="server" Columns="30" />
    ...
    <tbody id="DivFileType" style="display: none">
        <tr>
            ...
            <td>
                ...
                保存文件大小字段名：
                <asp:TextBox ID="TxtFileSizeField"  runat="server" Columns="20" /><br />
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TxtUploadFileType"  runat="server" Columns="30" />
        ...
        <tbody id="DivOperatingType" style="display:none">
            <tr>
                <td class="tdbgleft">分行键入&nbsp;&nbsp;<br />
                    每个平台选项：</td>
                <td>
                    <asp:TextBox ID="TxtOperatingOption"  runat="server" 
                        TextMode="MultiLine" Columns="40" Rows="6" Height="79px" /> <span style="color: red">*</span> <span style="color: blue">注：一行一个默认项</span></td>
            </tr>
            <tr>
                <td class="tdbgleft">文本框长度：</td>
            ...
            <tr>
                <td class="tdbgleft">默认值：</td>
                <td><asp:TextBox ID="OperatingType_DefaultValue"  runat="server" Columns="30" /><span style="color: green">例：Win2000|XP|Win2003</span> </td>
            </tr>
        </tbody>
        <!--  超链接    -->
        <tbody id="DivSuperLinkType" style="display:none">
            ...
            <tr>
                <td class="tdbgleft">默认值：</td>
                <td><asp:TextBox ID="SuperLinkType_DefaultValue"  runat="server" Columns="30" /><span style="color: green">例：http://127.0.0.1/</span></td>
            </tr>
        </tbody> 
        <!--  多级选项    -->
        ...
        <tbody id="DivNumType" style="display:none">
            ...
            <tr>
                <td class="tdbgleft">默认值：</td>
                <td><asp:TextBox ID="NumberType_DefaultValue"  runat="server" Columns="10" /></td>
            </tr>
            <tr class="tdbg">
                <td class="tdbgleft">
                搜索设置：
            ...
            <tr>
                ...
                <td>
                    <table cellspacing="0" cellpadding="0" width="100%" border="0" align="center">
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="NumSearchRange"  runat="server" 
                                    TextMode="MultiLine" Columns="40" Rows="6" Height="92px" /><br />                                    
                            </td>
                            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="ColorDefault"  runat="server" MaxLength="7"  Columns="7" style="font-size: 9pt; height: 15px;" />
        ...
        <tbody id="DivMobileSMS" style="display: none">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="MobileSMSType_Width"  runat="server" Columns="10" MaxLength="4">500</asp:TextBox>px
                </td>
            </tr>
            <tr>
                <td class="tdbgleft">
                ...
                <td>
                    <asp:TextBox ID="MobileSMSType_Height"  runat="server" Columns="10" MaxLength="4">200</asp:TextBox>px
                </td>
            </tr>
        </tbody>
        <tbody runat="server" id="DivRemoteFile" style="display: none">
           <tr>
                ...
                <td>
                    <asp:TextBox ID="TxtMaxFileSize2" Css runat="server" Columns="5">1024</asp:TextBox>KB
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TxtUploadFileType2" Css runat="server" Columns="30" />
                    <span style="color: red">*</span>
