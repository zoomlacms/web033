<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_ShopRecycler, App_Web_vzmvl1l4" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                ...
                <ItemTemplate>
                    ...
                    <asp:LinkButton ID="LinkButton2" CommandName="Del1" CommandArgument='<%# Eval("ID") %>' OnClientClick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');" runat="server" CssClass="option_style"><i class="fa fa-trash-o" title="删除"></i></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
