<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_Arrive_ArriveManage, App_Web_0pwjxxe5" enableviewstate="true" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <ZL:ExGridView ID="gvCard" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" RowStyle-CssClass="tdbg"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                        <ItemTemplate>
                            <a id="abc" href='<%#Gethref(Eval("ID","{0}")) %>' class="option_style"><i class="fa fa-pencil" title="修改"></i></a>
                            <a id="a1" href='<%#del(Eval("ID","{0}")) %>' class="option_style"><i class="fa fa-trash-o" title="删除"></i></a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
                    </asp:TemplateField>
                </Columns>
