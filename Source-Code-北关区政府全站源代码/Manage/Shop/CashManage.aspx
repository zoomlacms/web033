<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_CashManage, App_Web_vzmvl1l4" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td height="22" align="center"><%#showuse(Eval("Y_ID").ToString()) %>
                        <a href="CashManage.aspx?menu=del&id=<%#Eval("Y_ID") %>" onclick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');"><i class="fa fa-trash-o" title="删除"></i></a>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
