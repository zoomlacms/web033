<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Manage/I/Default.master" inherits="Manage_Shop_OrderRepairAudit, App_Web_vzmvl1l4" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <ZL:ExGridView ID="EGV" runat="server" AllowPaging="True" AllowSorting="True" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        <a href="RepairDeailt.aspx?id=<%#Eval("ID") %>" class="option_style"><i class="fa fa-eye" title="查看"></i>查看详情</a>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </ZL:ExGridView>
