<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_ProductCashManage, App_Web_4utngsre" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-striped table-bordered table-hover">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
       ...
       <td height="22" align="center"><%# Eval("Account")%></td>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="CashManage.aspx?menu=del&id=<%#Eval("Y_ID") %>" OnClick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');"><i class="fa fa-trash-o" title="删除"></i></a></td>
      </tr>
        </ItemTemplate>
        </asp:Repeater>
        <tr class="tdbg">
