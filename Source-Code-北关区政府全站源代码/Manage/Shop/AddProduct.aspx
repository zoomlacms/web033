<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableeventvalidation="false" inherits="Zoomla.Website.manage.Shop.AddProduct, App_Web_vzmvl1l4" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" viewStateEncryptionMode="Never" %>
   ...
   <table class="table table-striped table-bordered">
                    ...
                    <tbody id="Tabs2" style="border-top:none;display: none">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Rate" runat="server" Text="0" class="form-control text_s" />
                                <span>%</span>
                    ...
                    <tbody id="Tabs3" style="border-top:none;display: none">
                        ...
                        <tr>
                            ...
                            <td><asp:TextBox ID="txtRecommend" runat="server" Text="0" class="form-control text_s num" /><span>%</span></td>
                        </tr>
                        <tr>
