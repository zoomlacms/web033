<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_Orderlistinfo, App_Web_vzmvl1l4" validaterequest="false" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane" id="Financial">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading"><span class="glyphicon glyphicon-th"></span><span class="margin_l5">商品信息</span></div>
                            ...
                            <asp:Repeater ID="procart" runat="server" OnItemDataBound="cartinfo_ItemDataBound">
                                <ItemTemplate>
                                    <tr
                                        ...
                                        <td ><img src="<%#ZoomLa.Common.function.GetImgUrl(Eval("Thumbnails"))%>" onerror="this.src='/Images/nopic.gif';" class="img_50" /></td>
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        <ItemTemplate>
                                            <tr
                                                ...
                                                <td align="center">
                                                    <img src="<%#ZoomLa.Common.function.GetImgUrl(Eval("Thumbnails"))%>" onerror="this.src='/Images/nopic.gif';" class="img_50" />
                                                </td>
                                                <td align="center">
    ...
    <table class="table table-striped table-bordered table-hover">
        <tr>
            ...
            <td width="20%">
                ...
                <asp:Button ID="CompleteOrder_Btn" runat="server" Text="完结订单" CssClass="btn btn-primary" OnClick="CompleteOrder_Btn_Click"  OnClientClick="return confirm('确定完结订单吗,充值,IDC等将会完成充值操作!');" />
            </td>
            <td width="20%">
            ...
            <td width="20%" rowspan="3">
                ...
                <asp:Button ID="sendScore" class="btn btn-primary" runat="server" Text="赠送积分"  OnClick="sendScore_Click" /><br />
            </td>
        </tr>
        <tr>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script type="text/javascript">
        ...
        function preview() {
            location.href = "Orderlistinfo.aspx?id=" +<%:Mid %> +"&menu=print";
        }
        //打印功能
        function pageload() {
