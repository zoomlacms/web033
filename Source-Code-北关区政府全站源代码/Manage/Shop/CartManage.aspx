<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.CartManage, App_Web_vzmvl1l4" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <asp:Repeater ID="Carttable" runat="server"
            ...
            <ItemTemplate>
                <tr class="tdbg" id="<%#Eval("ID")%>" ondblclick="getinfo(this.id)">
                    ...
                    <td>
                        <a href="?menu=del&id=<%#Eval("ID") %>" onclick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');" class="option_style"><i class="fa fa-trash-o" title="删除"></i></a>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
