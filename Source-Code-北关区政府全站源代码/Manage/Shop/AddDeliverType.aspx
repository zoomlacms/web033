<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_AddDeliverType, App_Web_4utngsre" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-bordered table-striped">
       ...
       <%-- <tr><td>是否包邮:</td><td>
            <input type="checkbox" runat="server" id="IsFree_Chk" class="switchChk"/></td></tr>--%>
        <tr><td>计价方式:</td><td>
