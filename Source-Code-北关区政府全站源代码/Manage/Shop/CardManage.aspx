<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_CardManage, App_Web_vzmvl1l4" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                    ...
                    <td height="22" align="center">
                        ...
                        <td height="22" align="center">
                            ...
                            <a href="CardManage.aspx?menu=del&id=<%#Eval("Card_ID") %>" onclick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');" class="option_style"><i class="fa fa-trash-o" title="删除"></i></a>
                        </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
