<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Common/Common.master" inherits="test_Delivery, App_Web_4utngsre" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="container">
        ...
        <table class="mytable">
            ...
            <tr><td class="tdbgleft">快递公司</td><td>
                <asp:DropDownList runat="server" ID="Express_DP" CssClass="form-control text_x" onchange="ExpChange(this);">
                     <asp:ListItem Value="顺风快递" Selected="True">顺风快递</asp:ListItem>
                     ...
                     <asp:ListItem Value="DedEx">DedEx</asp:ListItem>
