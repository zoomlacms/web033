<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_ShopGrade, App_Web_xra4s2yl" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <ItemTemplate>
                <tr ondblclick="editGrade('<%# Eval("ID") %>')">
                    ...
                    <td align="center">
                        ...
                        <a href="?menu=del&id=<%#Eval("ID") %>" onclick="return confirm('不可恢复性删除数据,你确定将该数据删除吗？');" class="option_style"><i class="fa fa-trash-o" title="删除"></i></a></td>
                </tr>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
