<%@ page language="C#" debug="true" autoeventwireup="true" inherits="manage_UserShopManage_StoreManage, App_Web_q4bys1ui" validaterequest="false" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        ...
                        <a href="StroeUpdate.aspx?username=<%#GetUsername(DataBinder.Eval(Container.DataItem, "GeneralID").ToString())%>" class="option_style"><i class="fa fa-pencil" title="修改"></i></a>
                        <a target="_blank" href="/Store/StoreIndex.aspx?id=<%#Eval("GeneralID") %>" class="option_style"><%#lang.LF("<i class='fa fa-globe'></i>浏览")%></a>                               
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </ZL:ExGridView>
