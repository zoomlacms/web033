<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Template_TemplateSetOfficial, App_Web_pwtmdret" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="panel panel-default" style="padding:0px;">
     <div class="panel-body" style="padding:0px;">
        <ul class="list-unstyled">
            <ZL:ExRepeater runat="server" ID="RPT" PageSize="14" PagePre="</div> <div class='panel-footer text-center'>" PageEnd="</div>">
                <ItemTemplate>
                    <li class="padding5">
                        <div class="Template_box Template_box2">
                            <div class="tempthumil tempthumil2">
                                <a href="<%#GetDownUrl() %>" title="点击下载模板">
                                    <img onmouseover="this.style.border='1px solid #9ac7f0';" onmouseout="this.style.border='1px solid #eee';" alt="<%#Eval("Project") %>" onerror="this.onerror=null;this.src='/Images/nopic.gif'" src='<%=serverdomain %>/Template/<%#Eval("TempDirName") %>/view.jpg'></a>
                            </div>
                            <span class="pull-right"><a href="<%#GetDownUrl() %>" title="下载模板"><i class="fa fa-cloud-download"></i></a><a href='<%=serverdomain %>/Template/<%#Eval("TempDirName") %>/Bview.jpg' class="lightbox" title="大图预览"><i class="fa fa-search-plus"></i></a></span>
