<%@ page language="C#" autoeventwireup="true" inherits="API_GetPageHtml, App_Web_pwtmdret" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content runat="server" ContentPlaceHolderID="head">
    <title>源码查看器</title>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <span class="pull-left" style="line-height: 32px;">目标网址：</span>
    <asp:TextBox ID="UrlText" CssClass="form-control text_md pull-left" runat="server">http://www.zoomla.cn</asp:TextBox>
