<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_CssManage, App_Web_pwtmdret" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                        ...
                        <tr>
                            ...
                            <td align="center">&nbsp;
                                <asp:LinkButton ID="LinkButton3" runat="server" CommandArgument='<%# Eval("Name").ToString()%>'
                                    ...
                                    Enabled='<%# System.Convert.ToInt32(Eval("type")) == 1 ? false:true %>' Visible='<%# System.Convert.ToInt32(Eval("type")) == 1 ? false : true %>' CssClass="option_style"><i class="fa fa-download" title="下载"></i></asp:LinkButton>
                        
                                <asp:LinkButton ID="LinkButton2" runat="server" CommandName='<%# System.Convert.ToInt32(Eval("type")) == 1 ? "CopyDir":"CopyFiles" %>'
                                    CommandArgument='<%# Eval("Name").ToString()%>' CssClass="option_style"><i class="fa fa-copy" title="复制"></i></asp:LinkButton>
                                ...
                                <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("Name").ToString()%>'
                                    ...
                                    OnClientClick="return confirm('你确认要删除该文件夹或文件吗？')" CssClass="option_style"><i class="fa fa-trash-o" title="删除"></i></asp:LinkButton>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
