<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" inherits="ZoomLa.WebSite.Manage.Template.labelSqlOne, App_Web_pwtmdret" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="row">
            <ol class="breadcrumb navbar-fixed-top">
                ...
                <li><a href="<%=Request.RawUrl %>">
                    ...
                    <a href="labelSqlOne.aspx?LabelName=<%=Request["LabelName"] %>">[多步式标签编辑器]</a></li>
                <%=Call.GetHelp(25) %>
            </ol>
        </div>
    </div>
