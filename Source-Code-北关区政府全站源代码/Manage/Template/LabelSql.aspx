<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_LabelSql, App_Web_pwtmdret" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <ol class="breadcrumb navbar-fixed-top">
                ...
                <li class="active">
                    <a href="<%=Request.RawUrl %>">
                        <asp:Label ID="LabelName_L" runat="server" /></a>
	...
	<table class="table table-striped table-bordered">
					...
					<tr>
					  <td><table class="table table-striped table-bordered">
						  <tr>
							...
							<td><asp:DropDownList ID="DatabaseList" CssClass="form-control text_md" runat="server" AutoPostBack="True" OnSelectedIndexChanged="TableDownList_SelectedIndexChanged" /></td>
						  </tr>
						  <tr>
							<td style="text-align: right;">主表： </td>
							<td><asp:DropDownList ID="DbTableDownList" CssClass="form-control text_md" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DBTableDownList_SelectedIndexChanged" /></td>
						  </tr>
						  <tr>
					  ...
					  <td><table id="table2" class="table table-striped table-bordered" runat="server">
						  <tr>
							<td style="width: 120px; text-align: right;">请选择数据库： </td>
							<td><asp:DropDownList ID="DatabaseList2" CssClass="form-control text_md" runat="server" /></td>
						  </tr>
						  <tr>
							<td style="width: 50px; text-align: right;">从表： </td>
							<td><asp:DropDownList ID="DbTableDownList2" CssClass="form-control text_md" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DBTableDownList2_SelectedIndexChanged" /></td>
						  </tr>
						  <tr>
							<td style="width: 50px; text-align: right;">输出字段： </td>
	  ...
	  <tbody id="tj" runat="server" visible="false">
		<tr>
		  ...
		  <td><div id="ycdiv" class="selectlist">
	  ...
	  <tbody>
		<tr>
		  ...
		  <td><asp:TextBox runat="server" ID="TxtSqlTable" TextMode="MultiLine" class="form-control m715-50" Height="90"></asp:TextBox>
			<br />
		...
		<tr>
		  ...
		  <td><asp:TextBox runat="server" ID="TxtSqlField" TextMode="MultiLine" class="form-control m715-50" Height="90"></asp:TextBox>
			<br />
              <asp:Button ID="Button3" class="btn btn-info" runat="server" Text="查询字段" OnClick="Button3_Click" />
	  ...
	  <tbody>
		<tr style="display:none;">
		  ...
		  <td><asp:TextBox runat="server" ID="ProceName_Text" CssClass="form-control"></asp:TextBox></td>
		</tr>
	  </tbody>
	  <tr>
        <td></td>
  ...
  <asp:WizardStep ID="WizardStep3" runat="server" Title="step3">
	<table class="table table-striped table-bordered">
	  ...
	  <tr>
		...
		<td><table class="table table-striped table-bordered" style="text-align: center">
			<tr>
			  ...
			  <td class="text_md">参数类型 </td>
			  <td>参数说明 </td>
			  <td class="text_md">操作 </td>
			</tr>
			<asp:Repeater ID="repParam" runat="server" OnItemCommand="repParam_ItemCommand">
			  <ItemTemplate>
				<tr>
				  ...
				  <td class="text-center"><%# GetParamType(Eval("ParamType","{0}"))%></td>
            ...
            <tr>
			    ...
			    <td>
                    ...
                    <asp:HiddenField ID="HdnParam" runat="server" /><asp:HiddenField ID="HdnTempParam" runat="server" />
			    </td>
            </tr>
		  </table></td>
	  </tr>
	  ...
	  <tr>
		...
		<td>
            <div id="gridviewclause" class="input-group fielddiv" style="width: 680px;">
                <asp:DropDownList ID="DDLJointj" CssClass="form-control" style="border-right:none;width:80px;" runat="server">
			      <asp:ListItem Selected="True">And</asp:ListItem>
			      <asp:ListItem>OR</asp:ListItem>
			    </asp:DropDownList>
			    <asp:DropDownList ID="DDLFTable" CssClass="form-control" style="border-right:none;width:100px;" runat="server" AutoPostBack="True" OnSelectedIndexChanged="BindTableField">
			      <asp:ListItem Selected="True" Value="1">主表</asp:ListItem>
			      <asp:ListItem Value="2">从表</asp:ListItem>
			    </asp:DropDownList>
			    <asp:DropDownList ID="DDLTjField" CssClass=" form-control" runat="server" style="border-right:none;width:140px;"/>
			    <asp:DropDownList ID="DDLtj" CssClass=" form-control" style="border-right:none;width:100px;" runat="server">
			    ...
			    <asp:TextBox ID="TxtTjValue" class="form-control" style="border-right:none;width:150px;" runat="server"></asp:TextBox>
                <span class="input-group-btn">
                    <asp:Button ID="Button1" runat="server" class="btn btn-info" Text="添加查询条件" OnClick="Button1_Click" />
                </span>
            </div>
			<asp:TextBox ID="TxtSqlWhere" runat="server" class="form-control"  style="max-width:500px; margin-top:10px;height:100px;" TextMode="MultiLine"></asp:TextBox>
		  </td>
	  </tr>
	  <tr>
		...
		<td>
            <div id="Div2" class="fielddiv">
                <div class="input-group" style="width: 460px;">
                    <asp:DropDownList ID="DDLOrderTable" CssClass="form-control" style="border-right:none;width:100px;" runat="server" AutoPostBack="True" OnSelectedIndexChanged="BindOrderField">
                        <asp:ListItem Selected="True">主表</asp:ListItem>
                        <asp:ListItem>从表</asp:ListItem>
                    </asp:DropDownList>
                    <asp:DropDownList ID="DDLOrderField" CssClass="form-control" runat="server" style="border-right:none;width:150px;" />
                    <asp:DropDownList ID="DDLOrder" CssClass="form-control" style="border-right:none;width:100px;" runat="server">
                        <asp:ListItem Value="DESC">降序</asp:ListItem>
                        <asp:ListItem Value="ASC">升序</asp:ListItem>
                    </asp:DropDownList>
                    <span class="input-group-btn">
                        <asp:Button ID="Button2" class="btn btn-info" runat="server" Text="添加排序字段" OnClick="Button2_Click" ValidationGroup="false" />
                    </span>
                </div>
			<asp:TextBox ID="TxtOrder" class="form-control" runat="server" style="max-width:500px; margin-top:10px;" Rows="7" TextMode="MultiLine" Height="100"></asp:TextBox>
			<br />
	  ...
	  <tr style="display:none;">
		...
		<td><asp:TextBox runat="server" ID="ProceParam_Text" CssClass="form-control" TextMode="MultiLine" Height="100"></asp:TextBox></td>
	  </tr>
	  <tr>
		<td class="text-right">数据数目： </td>
		<td><asp:TextBox ID="TextBox1" class="form-control text_s" runat="server" Text="10"></asp:TextBox></td>
	  </tr>
	  <tr><td></td>
		<td>
  ...
  <asp:WizardStep ID="WizardStep4" runat="server" Title="step4">
	<table class="table table-striped table-bordered">
	  ...
	  <tr>
		...
		<td>  
            <asp:CheckBox ID="boolmodel" runat="server" Text="判断模式"/>
	  ...
	  <tr id="isbool" runat="server" visible="false">
		...
		<td><asp:DropDownList ID="Modeltypeinfo" CssClass="form-control pull-left" Width="110" runat="server">
		  ...
		  <asp:TextBox ID="Valueroot" runat="server" CssClass="form-control pull-left" Width="179px" onmousedown="inputtxt(this)" onfocus="inputtxt(this)" placeholder="这里放入标签"></asp:TextBox>
		  <asp:DropDownList ID="addroot" runat="server" CssClass="form-control td_m" Visible="false">
