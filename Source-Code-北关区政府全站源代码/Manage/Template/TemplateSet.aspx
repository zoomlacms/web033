<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_TemplateSet, App_Web_pwtmdret" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<span class="pull-right"><a href='/Template/<%#Eval("name") %>/Bview.jpg' class="lightbox" title="点击查看大图"><i class="fa fa-search-plus"></i></a></span>
