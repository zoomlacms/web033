<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="Manage_I_Content_TemplateEdit, App_Web_pwtmdret" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table width="100%" cellpadding="2" border="0" cellspacing="1" class="table table-striped table-bordered" align="center">
        ...
        <tr>
            <td align="left" colspan="2">
                ...
                <asp:LinkButton ID="ReTurn_LB" runat="server" OnClick="btnReset_Click" CssClass="btn btn-primary">
