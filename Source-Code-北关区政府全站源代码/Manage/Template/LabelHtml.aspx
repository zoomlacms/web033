<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.I.Template.LabelHtml, App_Web_pwtmdret" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table id="content" class="table table-striped table-bordered tab-content">
  <tbody class="tab-pane active" id="Info0">
    <tr>
      ...
      <td class="text-left" data-auto="maxwidth"><asp:TextBox ID="TxtLabelName" CssClass="form-control text_md" runat="server" />
    ...
    <tr>
      ...
      <td class="text-left"><asp:TextBox ID="TxtLabelType" CssClass="form-control text_md" runat="server"></asp:TextBox>
    ...
    <tr>
      ...
      <td class="text-left"><asp:TextBox ID="TxtLabelIntro" CssClass="form-control text_md label_explain" runat="server" TextMode="MultiLine" Columns="50" Rows="3"></asp:TextBox></td>
    </tr>
  </tbody>
  <tbody class="tab-pane" id="Info1">
    <tr>
      <td class="label_decide_name">判断模式： </td>
      <td data-auto="maxwidth"><asp:CheckBox ID="boolmodel" runat="server" Text="开启判断模式" AutoPostBack="True" />
        <font color="red">[开启后将根据判断条件输出内容]</font>
        <iframe id="I1" frameborder="0" name="I1" scrolling="no" src="/manage/Template/label.htm" class="label_iframe"></iframe></td>
    </tr>
    <tr id="isbool" runat="server" visible="false">
      <td class="text-center">模式设置： </td>
      <td><asp:DropDownList ID="Modeltypeinfo" CssClass="form-control text_md label_num" runat="server" AutoPostBack="True">
    ...
    <tr>
      <td class="text-right" style="width: 100%;" colspan="2"><table style="width: 100%">
          <tr>
            <td style="min-width:276px;width: 276px; vertical-align: top;" id="frmTitle"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tbody id="ss">
                  <tr align="center">
                          ...
                          <div class="tab-pane active" id="Tabs0" runat="server">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-striped table-bordered">
                              <tbody>
                                ...
                                <tr align="center">
                                  <td><div style="overflow: auto; height: 370px">
    ...
    <tr id="s2" runat="server" visible="false" onmouseover="this.className='tdbgmouseover'"
      ...
      <td style="width: 100%; text-align: right;" colspan="2"><table style="width: 100%">
          <tr>
            <td align="left"><asp:TextBox TextMode="MultiLine" runat="server" CssClass="form-control text_md" ID="falsecontent" Style="max-width: 100%; height: 231px;"></asp:TextBox></td>
          </tr>
        </table></td>
    </tr>
  </tbody>
  <tr>
    <td colspan="2"><asp:HiddenField ID="HdnLabelID" runat="server" />
      ...
      <asp:Button ID="BtnSave" runat="server" Text="保存标签" CssClass="btn btn-primary" OnClick="BtnSave_Click"  Style="cursor: pointer; cursor: pointer;" />
