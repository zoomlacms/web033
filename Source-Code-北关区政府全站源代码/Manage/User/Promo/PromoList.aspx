<%@ page language="C#" autoeventwireup="true" inherits="Manage_User_Promo_PromoList, App_Web_5qmr34ib" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="margin_t5">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                        <a href="PromoUserList.aspx?PUserID=<%#Eval("UserID") %>" class="option_style"><i class="fa fa-send-o" title="推广用户"></i>推广用户</a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
