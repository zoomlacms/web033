<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Manage/I/Default.master" inherits="Manage_User_Promo_PromoUserList, App_Web_5qmr34ib" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div id="sel_box" class="padding5">
            <div class="input-group text_300" style="float:left;">
                ...
                <span class="input-group-btn">
                    <asp:LinkButton ID="Search_Btn" runat="server" CssClass="btn btn-default" OnClick="Search_Btn_Click"><i class="glyphicon glyphicon-search"></i></asp:LinkButton>
                </span>
            </div>
            <div class="pull-left" style="margin-left:10px;">
                ...
                <asp:LinkButton ID="SearchDate_T" runat="server" CssClass="btn btn-default" OnClick="Search_Btn_Click"><i class="glyphicon glyphicon-search"></i></asp:LinkButton>
            </div>
        </div>
    </ol>
