<%@ page language="C#" autoeventwireup="true" inherits="Manage_User_UserManage, App_Web_x2mr5qil" title="会员管理" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div id="sel_box" class="padding5">
            <div class="input-group" style="float:left;">
		        ...
		        <asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-control" Style="width: 90px;border-right:none;">
                  ...
                  <asp:ListItem Value="HoneyName">昵称</asp:ListItem>
		        </asp:DropDownList>
  ...
  <ZL:Repeater runat="server" ID="RPT" PageSize="10" PagePre="<tr><td><label class='allchk_l'><input type='checkbox' id='AllID_Chk'>全选</label></td><td colspan='13'><div class='text-center'>" PageEnd="</div></td></tr>">
	<ItemTemplate>
	  <tr ondblclick="location='UserInfo.aspx?id=<%# Eval("UserID") %>';">
		...
		<td><a href='UserModify.aspx?UserID=<%# Eval("UserID")%>&tabs=Tabs4' class="option_style"><i class="fa fa-key" title="权限"></i>权限</a> 
