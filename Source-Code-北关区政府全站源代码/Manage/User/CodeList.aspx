<%@ page language="C#" autoeventwireup="true" inherits="Manage_User_CodeList, App_Web_x2mr5qil" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    ...
                    <a href="ServiceCode.aspx?ID=<%#Eval("ID") %>">修改</a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
