<%@ page language="C#" autoeventwireup="true" inherits="ZoomLaManage.WebSite.Manage.User.AddManage, App_Web_x2mr5qil" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                        <asp:TextBox ID="SPwd_T" runat="server" CssClass="form-control pull-left text_md"></asp:TextBox>
