<%@ page language="C#" autoeventwireup="true" inherits="manage_Qmail_RegValidateMail, App_Web_x2mr5qil" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
  ...
  <%} %></div>
    <table class="table table-striped table-bordered table-hover">
      ...
      <tr>
        ...
        <td><asp:TextBox ID="txtTitle" runat="server" Width="400px" class="form-control" ></asp:TextBox></td>
      </tr>
      <tr>
