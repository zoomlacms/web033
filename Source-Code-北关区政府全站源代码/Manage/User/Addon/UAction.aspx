<%@ page language="C#" autoeventwireup="true" inherits="Manage_User_Addon_UAction, App_Web_1rbwvexx" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="top_opbar">
        <div class="input-group" style="width: 310px; margin-left: 5px; float: left;">
            ...
            <span class="input-group-btn">
                <asp:LinkButton ID="Search_Btn" runat="server" CssClass="btn btn-default" Text="搜索" OnClick="Search_Btn_Click"><span class="glyphicon glyphicon-search"></span></asp:LinkButton>
            </span>
        </div>
    ...
    <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" IsHoldState="false"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="页面">
                <ItemTemplate><a href="<%#Eval("PageUrl") %>" title="点击浏览" target="_blank"><%#Eval("Title") %></a></ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    ...
                    <asp:LinkButton runat="server" CommandName='event' CommandArgument='<%#Eval("idflag") %>'>发起聊天</asp:LinkButton>
