<%@ page language="C#" autoeventwireup="true" inherits="Manage_User_UApiConfig, App_Web_jthjv4yd" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="ystep-step" id="step1">
    <div class="alert alert-info">第一步：可访问的数据库地址(*IP或诸如code.zoomla.cn形式的别名)
