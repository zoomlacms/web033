<%@ page language="C#" autoeventwireup="true" inherits="manage_User_AddMailTemp, App_Web_x2mr5qil" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td class="tdleft"><strong>上传缩略图：</strong></td>
            <td style="text-align: left">
        ...
        <tr>
            ...
            <td style="text-align: left">
               ...
               <%=Call.GetUEditor("TxtContent",4) %>
            </td>
        </tr>
        <tr>
            <td class="tdleft"><strong>邮件模板标签：</strong></td>
