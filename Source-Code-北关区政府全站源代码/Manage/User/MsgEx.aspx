<%@ page language="C#" autoeventwireup="true" inherits="manage_User_MsgEx, App_Web_x2mr5qil" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<%--            <asp:TemplateField HeaderText="内容">
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <a href="MsgList.aspx?suid=<%#Eval("UserID") %>&ruid=<%#Eval("ReceUser") %>" title="查看聊天详情" target="_blank">查看详情</a>
                    <a href="MsgInfo.aspx?id=<%#Eval("ID") %>">修改</a>
                    <asp:LinkButton ID="Del" runat="server" CommandName="del" OnClientClick="return confirm('确定删除该记录？')" CommandArgument='<%#Eval("ID") %>'>删除</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
