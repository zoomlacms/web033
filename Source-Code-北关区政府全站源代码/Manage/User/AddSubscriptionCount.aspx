<%@ page language="C#" autoeventwireup="true" inherits="manage_User_AddSubscriptionCount, App_Web_jthjv4yd" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div>
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <td  class="tdbgleft"><strong>投递标题：</strong></td>
                <td>
            ...
            <tr>
                <td class="tdbgleft" style="height: 26px"><strong>投递对象：</strong></td>
            ...
            <tbody id="priUser">
            <tr>
                <td class="tdbgleft"><strong>目标用户：</strong></td>
                <td>
            ...
            <tr>
                <td class="tdbgleft"><strong>用户组：</strong></td>
                <td><asp:DropDownList ID="ddGroup" runat="server" >
                </asp:DropDownList></td>
            </tr>
            </tbody>
            <tr>
            <td class="tdbgleft" style="height: 26px"><strong>允许退订：</strong></td>
            <td style="height: 26px">
