<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.Group, App_Web_x2mr5qil" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
  ...
  <table class="table table-striped table-bordered table-hover">
    ...
    <tr>
        <td class="tdbgleft td_l" ><strong>父会员组名称：</strong></td>
        <td><asp:Label ID="Label1" runat="server"></asp:Label></td>
    </tr>
    <tr>
      <td class="tdbgleft"><strong>会员组名称：</strong></td>
      <td><asp:TextBox class="form-control text_300" ID="TxtGroupName" runat="server" MaxLength="30" OnTextChanged="TxtGroupName_TextChanged" AutoPostBack="true" />
    ...
    <tr>
      ...
      <tr>
          <td class="tdbgleft"><strong>班级成员：</strong></td>
          <td>
              <asp:RadioButtonList ID="ClassEnroll_Radio" RepeatDirection="Horizontal" runat="server">
                  <asp:ListItem Value="" Selected="True">学生</asp:ListItem>
                  <asp:ListItem Value="isteach">教师</asp:ListItem>
                  <asp:ListItem Value="isfamily">家长</asp:ListItem>
              </asp:RadioButtonList>
          </td>
      </tr>
    <tr>
    ...
    <tr>
      ...
      <td><asp:TextBox class="form-control" style="max-width:150px;" ID="txtCreit" runat="server">0</asp:TextBox>
        <span>(用户达到多少信誉值可升级为此等级,0为不升级)</span>
    ...
    <tr>
      ...
      <td><span>每个包年会员费为</span><asp:TextBox class="form-control text_xs" ID="Byear" runat="server">50</asp:TextBox><span>,每个月最多使用</span><asp:TextBox class="form-control text_xs" ID="Payment" runat="server">50</asp:TextBox><span>篇文章</span>
