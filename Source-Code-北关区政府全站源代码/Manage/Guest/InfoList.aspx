<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Guest_InfoList, App_Web_4vabfs51" validaterequest="false" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="LinkButton3" runat="server" CommandArgument='<%#Eval("ID") %>' CommandName="show" CausesValidation="false" CssClass="option_style"><i class="fa fa-eye" title="显示"></i>设为显示</asp:LinkButton>
                        </ItemTemplate>
