<%@ page language="C#" autoeventwireup="true" inherits="Manage_Guest_GuestManage, App_Web_4vabfs51" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content  ContentPlaceHolderID="Content" Runat="Server">
    <asp:Repeater runat="server" ID="RPT" OnItemCommand="RPT_ItemCommand">
        ...
        <ItemTemplate>
            <tr data-layer="1" data-id="<%#Eval("CateID") %>" data-pid="0"  onclick="ShowChild(this,<%#Eval("CateID") %>);">
                <td><%#Eval("CateID") %></td>
                
                <td style="text-align:left;"><a href="Default.aspx?CateID=<%#Eval("CateID") %>"><span data-type="icon" class="glyphicon glyphicon-file rep_tree_icon" /></span></a><%#GetCateName()%></td>
                ...
                <td class='optd'>
                    ...
                    <asp:LinkButton CommandName="Del" CssClass="option_style" CommandArgument='<%#Eval("CateID") %>' OnClientClick="return confirm('确实要删除吗？');" runat="server"><i class="fa fa-trash-o" title="删除"></i></asp:LinkButton>
                </td>
            </tr>
        </ItemTemplate>
        <FooterTemplate>
