<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Guest_GuestCateMana, App_Web_4vabfs51" validaterequest="false" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="panel panel-default" style="padding: 0px;">
        <div class="panel panel-body" style="padding: 0px; margin: 0px;">
            <asp:Repeater runat="server" ID="RPT">
                <HeaderTemplate>
                    <table id="EGV" class="table table-bordered table-hover table-striped">
                        <tr>
                            <td>
                                <input type="checkbox" id="ALLID_Chk" /></td>
                            <td>ID</td>
                            <td>图片</td>
                            <td>栏目名称</td>
                            <td>栏目状态</td>
                ...
                <ItemTemplate>
                    <tr data-layer="1" data-id="<%#Eval("CateID") %>" data-pid="0" onclick="ShowChild(this);">
                        <td>
                            <input name="idchk" type="checkbox" value='<%#Eval("CateID")%>' /></td>
                        <td><%#Eval("CateID") %></td>
                        <td class='img_td'>
                        ...
                        <td class='optd'>
                            ...
                            <a href="javascript:;" onclick='DelConfirm(<%#Eval("CateID") %>,0);' class="option_style"><i class="fa fa-trash-o" title="删除"></i></a>
                            <%#(Eval("GType").ToString()=="0")?"":"<a href=\"javascript:;\" onclick=\"ShowCate(0,"+Eval("CateID")+");\" class='option_style'><i class='fa fa-plus' title='添加'></i>添加版面</a>" %>
                            <%#Eval("GType").ToString().Equals("1") ? "<a href='BarAuthSet.aspx?ID=" + Eval("CateID") + "' class='option_style'><i class='fa fa-key' title='权限'></i>权限</a>" : "" %>
            ...
            <script type="text/javascript">
                ...
                + "<a onclick='DelConfirm(@Cateid,0);' class='option_style' ><i class='fa fa-trash-o' title='删除'></i></a>"
                + "<a href='javascript:;' onclick='ShowCate(0,@Cateid);' class='option_style'><i class='fa fa-plus' title='添加'></i>添加版面</a>"
                + "<a href='BarAuthSet.aspx?ID=@Cateid' class='option_style'><i class='fa fa-key' title='权限'></i>权限</a><fun>HaschOrder('@_model');</fun></td></tr>";
