<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Manage/I/Default.master" inherits="Manage_I_Guest_TieList, App_Web_4vabfs51" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content  ContentPlaceHolderID="Content" Runat="Server">
	...
	<li><a href="#tab1" data-toggle="tab" onclick="ShowTabs(99)"><%:lang.LF("已审核") %></a></li>
</ul>
            ...
            <ZL:ExGridView ID="Egv1" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" PageSize="20" OnPageIndexChanging="Egv_PageIndexChanging" IsHoldState="false" OnRowCommand="Lnk_Click" AllowPaging="True" AllowSorting="True" CssClass="table table-striped table-bordered table-hover" EnableTheming="False" EnableModelValidation="True" EmptyDataText="无相关数据">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="<%#"/"+ZoomLa.BLL.B_Guest_Bar.CreateUrl(2,Convert.ToInt32(Eval("ID"))) %>" target="_blank" class="option_style"><%#lang.LF("<i class='fa fa-globe'></i>前台预览")%></a>
