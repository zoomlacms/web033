<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Guest_BarConfig, App_Web_4vabfs51" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="tab-content barconfig">
        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            <tr class="onlybar">
                ...
                <td>
                    ...
                    <button type="button" id="seluser_btn" class="btn btn-primary">选择</button>
    ...
    <div class="text-center">
        ...
        <a href="GuestCateMana.aspx?Type=<%:GType %>" class="btn btn-primary">返回</a>
