<%@ page language="C#" autoeventwireup="true" inherits="Manage_Site_ServerClusterConfig, App_Web_arjfynwg" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %> 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                       ...
                       <asp:LinkButton runat="server" CommandName="Del2" CommandArgument='<%#Eval("ID") %>' OnClientClick="return confirm('你确定要删除吗');" CssClass="option_style"><i class="glyphicon glyphicon-trash" title="删除"></i></asp:LinkButton>
                    </ItemTemplate>
                    <EditItemTemplate>
