<%@ page language="C#" autoeventwireup="true" inherits="manage_Site_AdminLogin, App_Web_35vgvlcp" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div id="site_main" class="padding5" style="padding-bottom:0;">
    ...
    <div id="editDiv">
        <ul style="margin-bottom:0;"><li><input type="button" value="编辑" onclick="dis('tab4');" class="btn btn-primary"/></li></ul>
    </div>
    <div id="tab4" style="display:none;">
        ...
        <table class="site_border">
        <tbody id="tabBody0" class="tabBody">
        <tr><td><span>超级管理员用户：</span></td><td><asp:TextBox runat="server" ID="adminName"  autocomplete="off" CssClass="form-control text_300" /></td></tr>
        <tr><td><span>超级管理员密码：</span></td><td>
        ...
        <tr><td><span>预设 站 点 URL：</span></td><td><asp:TextBox runat="server" ID="defaultIP" CssClass="form-control text_300" /></td></tr>
        <tr><td><span>模型ID：</span></td><td><asp:TextBox runat="server" ID="modelIDT"  CssClass="form-control text_300"/>&nbsp;&nbsp;<span style="color:green">注:IDC商城所绑定的模型ID</span></td></tr>
        <tr><td><span>商 城 节 点：</span></td><td><asp:TextBox runat="server" ID="nodeIDT"  CssClass="form-control text_300"/>&nbsp;&nbsp;<span style="color:green">注:IDC商城所绑定的节点ID</span></td></tr>
        <tr><td><span>新网代理用户：</span></td><td><asp:TextBox runat="server" ID="newNetClientID" CssClass="form-control text_300" />&nbsp;&nbsp;<span style="color:green;">注:以agent开头的用户</span></td></tr>
        <tr><td><span>新网API密码：</span></td><td><asp:TextBox runat="server" ID="newNetApiPasswd" TextMode="Password"
        onkeypress="if(event.keyCode==13){EnterFunc2();}" autocomplete="off"  CssClass="form-control text_300"/>&nbsp;&nbsp;<span style="color:green;">注:在API设置中配置,非登录密码</span></td></tr>
        <tr><td><span>DNS：</span></td>
        ...
        <tr><td><span>DNS文件输出目录：</span></td><td><asp:TextBox runat="server" ID="dnsOutputPath" MaxLength="50" CssClass="form-control text_300" /></td></tr>
        <tr class="cdnsBody"><td><span>DNS主服务器：</span></td><td> <asp:TextBox runat="server" ID="dns1" MaxLength="30"  CssClass="form-control text_300"/></td></tr>
        <tr class="cdnsBody"><td><span>DNS辅服务器：</span></td><td><asp:TextBox runat="server" ID="dns2" MaxLength="30"  CssClass="form-control text_300" /></td></tr>
        </tbody>
        <tbody id="tabBody1" style="display:none;" class="tabBody">
        <tr><td>二级域名：</td><td><asp:TextBox runat="server" ID="tDomNameT" MaxLength="50" CssClass="form-control text_300" /></td></tr>
        <tr><td>智能建站自动创建数据库：</td><td>
        ...
        <tr><td>数据库管理员帐号：</td><td><asp:TextBox runat="server" ID="dbm_NameT" MaxLength="20"  CssClass="form-control text_300" />注:推荐使用SA帐号,或拥有master数据库管理的帐号</td></tr>
        <tr><td>数据库管理员密码：</td><td><asp:TextBox runat="server" ID="dbm_PasswdT" MaxLength="50" TextMode="Password" CssClass="form-control text_300"  /></td></tr>
        </tbody>
        <tbody>
        <tr><td><span>操作：</span></td>
        <td>
