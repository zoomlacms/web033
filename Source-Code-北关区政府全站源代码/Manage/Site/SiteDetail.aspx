<%@ page language="C#" autoeventwireup="true" inherits="manage_Site_SiteDetail, App_Web_arjfynwg" masterpagefile="~/Manage/I/Default.master" title="站点详情" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div style="float:right;width:65%;margin-left:10px;">
            <div style="margin-top:41px; border:1px solid #ccc; padding-top:10px;">
                <ul style="list-style:none;" id="optionUL">
                  <li><a href="javascript:;" title="Mime设置" onclick="disFrame('Mime.aspx?siteName=<%=Server.UrlEncode(siteName) %>');"><i class="glyphicon glyphicon-cog"></i></a>
                      <br /><span>Mime设置</span></li>
                  <li><a href="javascript:;" title="虚拟目录" onclick="disFrame('VirtualDirectory.aspx?siteName=<%=Server.UrlEncode(siteName) %>');"><i class="glyphicon glyphicon-list"></i></a>
                ...
                <li><a href="javascript:;" title="绑定订单" onclick="disFrame('BountOrder.aspx?siteName=<%=Server.UrlEncode(siteName) %>');"><i class="glyphicon glyphicon-shopping-cart"></i></a>
...
<script type="text/javascript">
        ...
        function newadd() {
            var tr = "";
            tr += "<tr><td>新增绑定：<a href='javascript:' onclick='remove(this)' title='移除'><i class='glyphicon glyphicon-remove'></i></a></td><td>";
