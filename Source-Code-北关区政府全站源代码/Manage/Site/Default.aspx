<%@ page language="C#" autoeventwireup="true" inherits="IISMain, App_Web_arjfynwg" masterpagefile="~/Manage/I/Default.master" title="站点列表" enableviewstate="True" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
             ...
             <asp:TemplateField HeaderText="网站名称"  ItemStyle-CssClass="site_ico"  SortExpression="SiteState">
                 <ItemTemplate>
                   <a href="javascript:;" title="运行状态" style="position:relative; right:5px;">
                       <%#(Eval("SiteState") as string) == "Started" ? "<i class='glyphicon glyphicon-play'></i>" 
            ...
            <ItemStyle CssClass="site_ico"></ItemStyle>
             ...
             <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="site_a">
                 ...
                 <ItemTemplate>
                     ...
                     <asp:LinkButton  runat="server" CommandName="Edit2" CommandArgument='<%# Container.DisplayIndex %>' CssClass="option_style"><i class="glyphicon glyphicon-pencil" title="修改"></i></asp:LinkButton>
                     <a href="javascript:if(confirm('你确定要删除吗!')){ postToCS('del','<%#Eval("SiteName") %>')}" class="option_style" title="删除"><i class="fa fa-trash"></i></a>
                     <%#ShowOPBtn() %>
                     <a href="javascript:postToCS('restart','<%#Eval("SiteName") %>')" title="重启" class="option_style"><i class="glyphicon glyphicon-refresh"></i>重启</a>
                 </ItemTemplate>
                 <EditItemTemplate>
                     <asp:LinkButton ID="Save" runat="server" CommandName="Save" CommandArgument='<%# Container.DisplayIndex+":"+Eval("SiteID") %>' CssClass="option_style"><i class="glyphicon glyphicon-refresh" title="更新"></i></asp:LinkButton>
                     <asp:LinkButton ID="Cancel" runat="server" CommandName="Cancel" CommandArgument='<%# Container.DisplayIndex %>' CssClass="option_style"><i class="glyphicon glyphicon-remove" title="取消"></i></asp:LinkButton>
                 </EditItemTemplate>
             </asp:TemplateField>       
         </Columns>
