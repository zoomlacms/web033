<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_SpecialManage, App_Web_1obfz5ol" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <ItemTemplate>
              <tr data-layer="1" data-id='<%#Eval("SpecID") %>' onclick='LoadChilds(this,<%#Eval("SpecID") %>)'>
                  ...
                  <td>
                       ...
                       <a href="javascript:;" onclick='DelCofim(<%# Eval("SpecID")%>)' class="option_style"><i class="fa fa-trash-o" title="删除"></i></a>
                       <a href='/Special_<%# Eval("SpecID")%>/Default.aspx' title="前台预览" target="_blank" class="option_style"><%#lang.LF("<i class='fa fa-globe'></i>浏览")%></a>
                       <a href='AddSpec.aspx?Action=AddCh&ID=<%# Eval("SpecID")%>' class="option_style"><i class="fa fa-plus" title="添加"></i>添加子专题</a>
                       <a href='SpecContent.aspx?SpecID=<%#Eval("SpecID") %>' class="option_style"><i class="fa fa-navicon" title="内容"></i>专题内容</a>
                  </td>
              </tr>
            </ItemTemplate>
        </ZL:Repeater>
