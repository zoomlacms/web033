<%@ page language="C#" autoeventwireup="true" inherits="test_echart, App_Web_0qmbteha" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" role="tabpanel"  id="base_tb">
                        <table class="table table-bordered table-striped">
                           ...
                           <tr><td>主标题超链接:</td><td><asp:TextBox runat="server" CssClass="form-control text_300" ID="Link_T" Text="www.zoomla.cn" /></td></tr>
            ...
            <div class="container-fluid margin_t10" id="PreImg" style="display:none;">
