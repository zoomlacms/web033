<%@ page language="C#" autoeventwireup="true" inherits="test_SToS, App_Web_cbkalpir" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                     ...
                     <asp:Repeater runat="server" ID="ModelRPT" OnItemDataBound="ModelRPT_ItemDataBound">
                         <ItemTemplate>
                             <li>
                                 ...
                                 <span class="glyphicon glyphicon-arrow-right" style="font-size:1.5em;"></span>
    ...
    <script>
        ...
        $().ready(function(){
            $(".parent_node input").click(function(){
                ...
                if($parent.find(".icon").hasClass('glyphicon-folder-close')){
                    $parent.next().show();
                    $parent.find(".icon").removeClass('glyphicon-folder-close');
                    $parent.find(".icon").addClass('glyphicon-folder-open');
                }else{
                    $parent.next().hide();
                    $parent.find(".icon").removeClass('glyphicon-folder-open');
                    $parent.find(".icon").addClass('glyphicon-folder-close');
                }
            });
        });
