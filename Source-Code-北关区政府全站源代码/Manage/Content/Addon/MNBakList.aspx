<%@ page language="C#" autoeventwireup="true" inherits="Manage_Content_Addon_MNBakList, App_Web_cbkalpir" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
        ...
        <div class="row">
            <ol id="BreadNav" class="breadcrumb navbar-fixed-top">
                ...
                <li><a href="/test/mnbaklist.aspx">备份列表</a>
                    <asp:LinkButton runat="server" ID="CreateBak_Btn" CssClass="btn btn-primary" Style="margin-left: 10px;" OnClientClick="return confirm('确定要创建当前备份吗?');" OnClick="CreateBak_Btn_Click">创建备份</asp:LinkButton></li>
            </ol>
        </div>
    </div>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    ...
                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("name") %>' CommandName="restore" CssClass="option_style" OnClientClick="return confirm('确定要恢复该备份吗?');"><i class="fa fa-recycle"> 恢复</i></asp:LinkButton>
                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("name") %>' CommandName="del2" CssClass="option_style" OnClientClick="return confirm('确定要删除该备份吗?');"><i class="fa  fa-trash-o"> 删除</i></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
    <div class="alert alert-info">
        <ul>
            ...
            <li>元数据还原后，系统的[ZL_Node,ZL_Node_ModelTemplate,ZL_Model,ZL_ModelField,ZL_UserPromotions,ZL_NodeRole]表会进行还原</li>
            <li>我们强烈推荐执行此操作前,先<a href="../../Config/BackupRestore.aspx">[备份系统数据库]</a></li>
        </ul>
    </div>
</asp:Content>
