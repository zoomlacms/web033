<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_AddSpec, App_Web_uo3ttnj3" masterpagefile="~/Manage/I/Default.master" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <table class="table table-striped table-bordered table-hover">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtSpecName" onchange="CheckSpecName()" runat="server" onkeyup="Getpy('TxtSpecName','TxtSpecDir')" class="form-control pull-left" style="max-width:200px;" autofocus="true"  />
