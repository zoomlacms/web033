<%@ page language="C#" autoeventwireup="true" inherits="V_Content_AddContent, App_Web_1obfz5ol" masterpagefile="~/Manage/I/Default.master" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="ConInfo">
                <table id="mainTable" class="table table-bordered table_padding0 addcontent_modeltale" >
                   ...
                   <tr id="spec_tr">
                    ...
                    <tr runat="server">
                        <td class="fd_td_l"><asp:Label ID="Label4" runat="server" Text="副标题"></asp:Label></td>
                        <td>
            ...
            <div class="tab-pane fade" id="InfoAttr">
                <table class="table table-bordered table_padding0">
                    ...
                    <tr>
                        <td class="fd_td_l"><asp:Label ID="gx_time" runat="server" Text="更新时间"></asp:Label></td>
                        <td>
                    ...
                    <tr>
                        <td class="fd_td_l"><asp:Label ID="hits_txt" runat="server" Text="点击统计"></asp:Label></td>
                        <td>
            ...
            <div class="tab-pane fade" id="Process">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td><asp:CheckBox ID="ChkAudit" runat="server" />推荐</td>
                    </tr>
