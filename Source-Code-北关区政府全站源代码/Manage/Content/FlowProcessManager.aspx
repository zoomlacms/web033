<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.FlowProcessManager, App_Web_zz5lfliw" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="流程步骤操作 " ShowHeader="False">
				...
				<asp:LinkButton ID="lbDel" runat="server" CausesValidation="False" OnClientClick="{return confirm('你确定要将所有选择项删除吗？')}"
                    CommandName="Delete" CssClass="option_style"><i class="fa fa-trash-o" title="删除"></i></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
