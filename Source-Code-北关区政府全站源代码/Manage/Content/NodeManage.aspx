<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_NodeManage, App_Web_zz5lfliw" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered table-hover nodelist_div">
	...
	<asp:Repeater ID="RPT" runat="server" EnableViewState="false">
		<ItemTemplate>
			<tr onclick="getNodeList(this,'nodeList','<%#Eval("NodeID")%>');" class="list<%# Eval("ParentID") %>" id='list<%#Eval("NodeID")%>' name="list<%#Eval("ParentID")%>"
