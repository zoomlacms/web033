<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_ModelField, App_Web_zz5lfliw" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="panel-body padding0">
        <table id="FieldList" class="table table-striped table-bordered table-hover">
            ...
            <ZL:Repeater ID="RPT" runat="server" OnItemCommand="rptModelField_ItemCommand">
                <ItemTemplate>
                    <tr data-id="<%#Eval("FieldID") %>" ondblclick="location.href='AddModelField.aspx?FieldID=<%# Eval("FieldID") %>&ModelID=<%# Eval("ModelID") %>&ModelType=<%:ModelType %>'">
                        <td><%#GetChk() %></td>
                        <td>
        ...
        <div class="panel-footer">
            ...
            <asp:Button runat="server" ID="BatDel_Btn" CssClass="btn btn-primary" OnClick="BatDel_Btn_Click" OnClientClick="return confirm('确定要删除选定字段吗?');" Text="批量删除" />
        </div>
    </div>
</div>
