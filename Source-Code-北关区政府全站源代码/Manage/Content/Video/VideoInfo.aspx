<%@ page language="C#" autoeventwireup="true" inherits="Manage_Content_Video_VideoInfo, App_Web_5qsgfrlv" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <img src="#" onerror="this.src='/Images/nopic.gif';" runat="server" id="Thum_Img" />
