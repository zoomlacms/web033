<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_EditNode, App_Web_zz5lfliw" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <table width="100%" class="table table-striped table-bordered table-hover" cellpadding="2" cellspacing="1">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input id="EDHid" type="hidden" runat="server" />
