<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_CommentView, App_Web_zz5lfliw" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div>
        <table class="table table-bordered">
            ...
            <tr>
                <td>标题</td>
                <td>
                    <asp:TextBox runat="server" ID="Title" CssClass="form-control text_300"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>评论内容</td>
