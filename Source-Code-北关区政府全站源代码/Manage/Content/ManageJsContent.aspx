<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_ManageJsContent, App_Web_zz5lfliw" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    ...
    <table width="100%" cellpadding="2" cellspacing="1" border="0" align="center" class="table table-striped table-bordered table-hover">
        <tr class="title">
            ...
            <td align="center" width="25%">简介</td>
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <tr onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" class="tdbg" ondblclick="getinfo('<%#Eval("id")%>','<%#Eval("JsType")%>')">
                    ...
                    <td align="center">
                        <a href="<%#(Eval("JsType","{0}")=="1")?"AddJsPic.aspx":"AddJsContent.aspx" %>?menu=edit&id=<%#Eval("id") %>" class="option_style"><i class="fa fa-gear" title="设置"></i>参数设置</a> <a href="?menu=refresh&id=<%#Eval("id") %>" class="option_style"><i class="fa fa-refresh" title="刷新"></i>刷新</a>
                         <a href="?menu=delete&id=<%#Eval("id") %>" onclick="return confirm('真的要删除此JS文件吗？如果有文件或模板中使用此JS文件，请注意修改过来！');" class="option_style"><i class="fa fa-trash-o" title="删除"></i></a>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
