<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_AddEditModel, App_Web_zz5lfliw" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
	...
	<tr class="tdbg">
		...
		<td>
            ...
            <span class="spanl_30">
			<asp:RequiredFieldValidator ID="R1" runat="server" ForeColor="Red" ErrorMessage="内容模型名称不能为空" ControlToValidate="TxtModelName" /></span>
		</td>
	</tr>
	<tr class="tdbg">
		<td class="tdbgleft">
		...
		<td>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="RequiredFieldValidator" ForeColor="Red" ControlToValidate="TxtTableName">数据表名不能为空</asp:RequiredFieldValidator>
		</td>
	</tr>
	...
	<tr class="tdbg">
		...
		<td>
            ...
            <span class="spanl_30"><span class="rd_red">*</span>
			<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TxtItemName" ForeColor="Red" ErrorMessage="项目名称不能为空" /></span>
		</td>
	</tr>
	<tr class="tdbg">
		<td class="tdbgleft">
