<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_AddModelField, App_Web_1obfz5ol" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<li><asp:Label ID="lblModel" runat="server"></asp:Label> 当前表:[<asp:Label CssClass="rd_red" ID="Label1" runat="server"></asp:Label>]</li>
<%= Call.GetHelp(64) %>
</ol>
