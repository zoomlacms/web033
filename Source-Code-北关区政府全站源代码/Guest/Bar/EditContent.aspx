<%@ page language="C#" autoeventwireup="true" inherits="Guest_Bar_EditContent, App_Web_0qp21b2t" masterpagefile="~/Guest/Guest.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div runat="server" id="send_div">
        <div style="padding-top:5px;padding-bottom:2px;">
            <div>
                <span class="pull-left">  
                    ...
                    <a href="<%=ZoomLa.BLL.B_Guest_Bar.CreateUrl(2, PostID) %>">
        ...
        <div id="SendDiv" runat="server">
          <span id="Valid_S" runat="server" visible="false">
              <asp:TextBox ID="VCode" placeholder="验证码" MaxLength="6" runat="server" style="display:inline-block" CssClass="form-control text_x" />
