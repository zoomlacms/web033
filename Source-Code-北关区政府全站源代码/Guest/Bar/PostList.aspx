<%@ page language="C#" autoeventwireup="true" inherits="Guest_Bar_PostList, App_Web_0qp21b2t" masterpagefile="~/Guest/Guest.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<h5 class="well well-sm"><strong>子版块</strong></h5>
    <asp:Repeater runat="server" ID="ChildRPT" EnableViewState="false">
        ...
        <ItemTemplate>
            <tr>
                <td class="bar_imgDiv">
                    <img src="<%#Eval("BarImage") %>" onerror="this.src='/Images/nopic.gif';" /></td>
                <td class="barname">
        ...
        <ItemTemplate>
            <div class="tie_list">
                ...
                <div class="subdiv">
                    ...
                    <div id="sub_qvideo_div_<%#Eval("ID") %>" style="display: none;">
                         <div class="font12">
                             ...
                             <span><span class="glyphicon glyphicon-th-large"></span><a class="fullscreen_href" href="#" >全屏</a></span>
                         </div>
                ...
                <div class="font12 tie_rel_count">
                    <div><span class="glyphicon glyphicon-user"></span><a href="<%#CreateUrl(1,"")+"?uid="+Eval("CUser") %>"><%# GetUName()%></a></div>
                    <div><%#GetRUser() %></div>
                </div>
                <div class="clearboth"></div>
            </div>
...
<div class="floattool">
    <ul>
        ...
        <li onclick="returnDown()" onmouseout="hideTxt(this)" onmouseover="showTxt(this)"><a href="<%:Request.RawUrl %>"><span class="glyphicon glyphicon-edit"></span></a><span class="txtSpan">发 表 帖 子</span></li>
...
<div runat="server" id="barowner_div" visible="false" class="zIndex9">
    <div id="funcdiv" class="panel panel-primary candrag">    
        ...
        <div class="panel-body">
            ...
            <div style="padding: 5px;">
                <div class="func_item"><asp:LinkButton runat="server" CommandArgument="AddTop" OnClick="Bar_Btn_Click" ><i class="fa fa-level-up"><span> 置顶</span></i>置为头条帖子</asp:LinkButton></div>
                ...
                <div class="func_item"><asp:LinkButton runat="server" CommandArgument="RemoveTop" OnClick="Bar_Btn_Click" ><i class="fa fa-backward"><span> 取消置顶</span></i>有更好的啦</asp:LinkButton></div>                
                <div class="func_item"><asp:LinkButton runat="server" CommandArgument="RemoveBottom" OnClick="Bar_Btn_Click" ><i class="fa fa-forward"><span> 取消沉底</span></i>放上来再晒晒</asp:LinkButton></div>                
            </div>
        </div>
    </div>
