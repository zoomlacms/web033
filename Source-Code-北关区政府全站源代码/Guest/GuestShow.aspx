<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="BBS_GuestShow, App_Web_mp0d2vw4" enableviewstatemac="false" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>

<asp:Content runat="server" ContentPlaceHolderID="head"><title>阅读留言-<%Call.Label("{$SiteName/}"); %>留言</title></asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="container">
        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 ask_logo"><a href="/Guest/Ask/Default.aspx">
            <img src='<%Call.Label("{$LogoUrl/}"); %>' alt="<%Call.Label("{$SiteName/}"); %>留言系统" /></a></div>
    ...
    <div class="container content">
        <div class="dh">您的位置：<a href="/">网站首页</a>>><a href="/guest/">留言中心</a>>>查看留言</span></div>
    </div>
    <div class="container">
        <div class="s_body">
            <div id="g_show">
                ...
                <div id="replyDiv" runat="server">
                    <table class="table table-bordered">
                        <tr>
                            <td>发表回复:</td>
                            <td>
                                <textarea id="TxtContents" style="width: 100%; height: 300px;" name="TxtTContent" runat="server"></textarea>
                                <span id="sp2"></span>
                        ...
                        <tr>
                            <td>验证码</td>
                            <td>
                                <asp:TextBox ID="VCode" MaxLength="6" CssClass="form-control" runat="server" Style="width: 100px; height: 34px; display: inline;" autocomplete="off" />
                                <img id="VCode_img" title="点击刷新验证码" class="code" style="height: 34px;" />
                                <input type="hidden" id="VCode_hid" name="VCode_hid" /></td>
                        </tr>
                        <tr>
                            <td colspan="2" align="center">
                                <asp:Button ID="EBtnSubmit2" runat="server" CssClass="btn btn-primary i_bottom" Text="发表回复" OnClick="EBtnSubmit_Click" OnClientClick="return CheckDirty()" Style="margin-top: 10px;" /></td>
                        </tr>
                    </table>
                </div>
                <!--replyDiv end-->
