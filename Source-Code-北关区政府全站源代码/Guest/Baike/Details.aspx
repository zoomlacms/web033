<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Guest/Baike/Baike.master" clientidmode="Static" inherits="Guestbook_BkDetails, App_Web_dzc4ui2z" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<p class="text-center"><%Call.Label("{$Copyright/}"); %></p>
    ...
    <style type="text/css">
        ...
        #topcontrol
        {
            ...
            width: 50px;
            height: 50px;
            background: url(/App_Themes/User/top.jpg);
            margin-right: 14px;
            margin-bottom: 44px;
        }
