<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Guest/Baike/Baike.master" clientidmode="Static" inherits="Guestbook_BkSearch, App_Web_ibtbkheh" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Repeater ID="Repeater1" runat="server"  OnItemDataBound="Repeater1_ItemDataBound">
	<ItemTemplate>
		<li class="col-lg-4 col-md-4 col-sm-4 col-xs-12"><a href="/Guest/Baike/Search.aspx?Gtype=<%#Eval("GradeID") %>" title="<%#Eval("GradeName") %>"><%#Eval("GradeName") %></a>
