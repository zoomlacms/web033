...
- [Zoomla!逐浪CMS卓越出品](#zoomla逐浪cms卓越出品)
  - [逐浪官方开源精品全站项目033：安阳北关政府网](#逐浪官方开源精品全站项目033安阳北关政府网)
  - [本项目介绍](#本项目介绍)
- [开放性说明](#开放性说明)
  - [使用说明](#使用说明)
- [接口文档](#接口文档)
...
这是一个区政府的全站系统，移动优先，全面支持响应式，其特征包括：
- 服务端基于Zoomla!逐浪CMS开发
- 前端web呈现基于Boostrap 
...
![系统效果图4](demo-show-系统效果图/5.jpg)
![系统效果图4](demo-show-系统效果图/6.jpg)
